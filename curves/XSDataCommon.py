...
#
# Generated Mon Jul 6 11:52::09 2015 by EDGenerateDS.
#
...
class XSConfiguration(object):
    def __init__(self, XSPluginList=None, XSImportConfiguration=None):
        if XSImportConfiguration is None:
            ...
            strMessage = (
                "ERROR! XSConfiguration constructor argument 'XSImportConfiguration' is not list but %s"
                % self._XSImportConfiguration.__class__.__name__
            )
        ...
        if XSPluginList is None:
            ...
            strMessage = (
                "ERROR! XSConfiguration constructor argument 'XSPluginList' is not XSPluginList but %s"
                % self._XSPluginList.__class__.__name__
            )
            raise BaseException(strMessage)

    # Methods and properties for the 'XSImportConfiguration' attribute
    def getXSImportConfiguration(self):
        return self._XSImportConfiguration
    ...
    def setXSImportConfiguration(self, XSImportConfiguration):
        if XSImportConfiguration is None:
            ...
            strMessage = (
                "ERROR! XSConfiguration.setXSImportConfiguration argument is not list but %s"
                % XSImportConfiguration.__class__.__name__
            )
            raise BaseException(strMessage)

    def delXSImportConfiguration(self):
        self._XSImportConfiguration = None

    XSImportConfiguration = property(
        getXSImportConfiguration,
        setXSImportConfiguration,
        delXSImportConfiguration,
        "Property for XSImportConfiguration",
    )

    def addXSImportConfiguration(self, value):
        if value is None:
            strMessage = (
                "ERROR! XSConfiguration.addXSImportConfiguration argument is None"
            )
            raise BaseException(strMessage)
            ...
            strMessage = (
                "ERROR! XSConfiguration.addXSImportConfiguration argument is not XSImportConfiguration but %s"
    ...
    def setXSPluginList(self, XSPluginList):
        if XSPluginList is None:
            ...
            strMessage = (
                "ERROR! XSConfiguration.setXSPluginList argument is not XSPluginList but %s"
                % XSPluginList.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def buildChildren(self, child_, nodeName_):
        if (
            ...
            and nodeName_ == "XSImportConfiguration"
        ):
            obj_ = XSImportConfiguration()
            obj_.build(child_)
            self.XSImportConfiguration.append(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "XSPluginList":
            obj_ = XSPluginList()
            obj_.build(child_)
...
class XSData(object):
    ...
    def importFromDict(inDict):
        ...
        if "__XSDataName" in inDict:
            ...
            if module is None:
                print(
                    "Error, Dictionary does not represent an XSData object. module %s not in memory"
                    % strModuleName
                )
            else:
                if hasattr(module, strClassName):
                    ...
                    print(
                        "Error, Dictionary does not represent an XSData object. Class %s not in module %s"
                        % (strClassName, strModuleName)
                    )
        else:
            print(
                "Error, Dictionary does not represent an XSData object. no __XSDataName"
            )
        if xsd is not None:
...
class XSDataDictionary(object):
    def __init__(self, keyValuePair=None):
        if keyValuePair is None:
            ...
            strMessage = (
                "ERROR! XSDataDictionary constructor argument 'keyValuePair' is not list but %s"
                % self._keyValuePair.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setKeyValuePair(self, keyValuePair):
        if keyValuePair is None:
            ...
            strMessage = (
                "ERROR! XSDataDictionary.setKeyValuePair argument is not list but %s"
                % keyValuePair.__class__.__name__
            )
            raise BaseException(strMessage)

    def delKeyValuePair(self):
        self._keyValuePair = None
    ...
    def addKeyValuePair(self, value):
        if value is None:
            ...
            strMessage = (
                "ERROR! XSDataDictionary.addKeyValuePair argument is not XSDataKeyValuePair but %s"
                % value.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def insertKeyValuePair(self, index, value):
        if index is None:
            strMessage = (
                "ERROR! XSDataDictionary.insertKeyValuePair argument 'index' is None"
            )
            raise BaseException(strMessage)
        if value is None:
            strMessage = (
                "ERROR! XSDataDictionary.insertKeyValuePair argument 'value' is None"
            )
            raise BaseException(strMessage)
        elif value.__class__.__name__ == "XSDataKeyValuePair":
...
class XSDataExecutionInfo(object):
    ...
    def __init__(
        ...
        if baseDirectory is None:
            ...
            strMessage = (
                "ERROR! XSDataExecutionInfo constructor argument 'baseDirectory' is not XSDataFile but %s"
                % self._baseDirectory.__class__.__name__
            )
            raise BaseException(strMessage)
        if configuration is None:
            ...
            strMessage = (
                "ERROR! XSDataExecutionInfo constructor argument 'configuration' is not XSConfiguration but %s"
        ...
        if executionTime is None:
            ...
            strMessage = (
                "ERROR! XSDataExecutionInfo constructor argument 'executionTime' is not XSDataTime but %s"
                % self._executionTime.__class__.__name__
            )
            raise BaseException(strMessage)
        if pluginName is None:
            ...
            strMessage = (
                "ERROR! XSDataExecutionInfo constructor argument 'pluginName' is not XSDataString but %s"
                % self._pluginName.__class__.__name__
            )
            raise BaseException(strMessage)
        if startOfExecution is None:
            ...
            strMessage = (
                "ERROR! XSDataExecutionInfo constructor argument 'startOfExecution' is not XSDataDate but %s"
                % self._startOfExecution.__class__.__name__
            )
            raise BaseException(strMessage)
        if systeminfo is None:
            ...
            strMessage = (
                "ERROR! XSDataExecutionInfo constructor argument 'systeminfo' is not XSDataSysteminfo but %s"
                % self._systeminfo.__class__.__name__
            )
            raise BaseException(strMessage)
        if workingDirectory is None:
            ...
            strMessage = (
                "ERROR! XSDataExecutionInfo constructor argument 'workingDirectory' is not XSDataFile but %s"
                % self._workingDirectory.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setBaseDirectory(self, baseDirectory):
        if baseDirectory is None:
            ...
            strMessage = (
                "ERROR! XSDataExecutionInfo.setBaseDirectory argument is not XSDataFile but %s"
                % baseDirectory.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setConfiguration(self, configuration):
        if configuration is None:
            ...
            strMessage = (
                "ERROR! XSDataExecutionInfo.setConfiguration argument is not XSConfiguration but %s"
                % configuration.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setExecutionTime(self, executionTime):
        if executionTime is None:
            ...
            strMessage = (
                "ERROR! XSDataExecutionInfo.setExecutionTime argument is not XSDataTime but %s"
                % executionTime.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setPluginName(self, pluginName):
        if pluginName is None:
            ...
            strMessage = (
                "ERROR! XSDataExecutionInfo.setPluginName argument is not XSDataString but %s"
                % pluginName.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setStartOfExecution(self, startOfExecution):
        if startOfExecution is None:
            ...
            strMessage = (
                "ERROR! XSDataExecutionInfo.setStartOfExecution argument is not XSDataDate but %s"
                % startOfExecution.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setSysteminfo(self, systeminfo):
        if systeminfo is None:
            ...
            strMessage = (
                "ERROR! XSDataExecutionInfo.setSysteminfo argument is not XSDataSysteminfo but %s"
                % systeminfo.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setWorkingDirectory(self, workingDirectory):
        if workingDirectory is None:
            ...
            strMessage = (
                "ERROR! XSDataExecutionInfo.setWorkingDirectory argument is not XSDataFile but %s"
                % workingDirectory.__class__.__name__
            )
            raise BaseException(strMessage)
...
class XSDataKeyValuePair(object):
    def __init__(self, value=None, key=None):
        if key is None:
            ...
            strMessage = (
                "ERROR! XSDataKeyValuePair constructor argument 'key' is not XSDataString but %s"
                % self._key.__class__.__name__
            )
            raise BaseException(strMessage)
        if value is None:
            self._value = None
            ...
            strMessage = (
                "ERROR! XSDataKeyValuePair constructor argument 'value' is not XSDataString but %s"
    ...
    def setKey(self, key):
        if key is None:
            ...
            strMessage = (
                "ERROR! XSDataKeyValuePair.setKey argument is not XSDataString but %s"
    ...
    def setValue(self, value):
        if value is None:
            ...
            strMessage = (
                "ERROR! XSDataKeyValuePair.setValue argument is not XSDataString but %s"
                % value.__class__.__name__
            )
            raise BaseException(strMessage)
...
class XSImportConfiguration(object):
    ...
    def buildChildren(self, child_, nodeName_):
        if child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "directory":
            value_ = ""
    ...
    def outputFile(self, _outfileName):
        print(
            "WARNING: Method outputFile in class XSImportConfiguration is deprecated, please use instead exportToFile!"
        )
        self.exportToFile(_outfileName)
...
class XSParamList(object):
    def __init__(self, XSParamItem=None):
        if XSParamItem is None:
            ...
            strMessage = (
                "ERROR! XSParamList constructor argument 'XSParamItem' is not list but %s"
                % self._XSParamItem.__class__.__name__
            )
            raise BaseException(strMessage)

    # Methods and properties for the 'XSParamItem' attribute
    def getXSParamItem(self):
        return self._XSParamItem
    ...
    def setXSParamItem(self, XSParamItem):
        if XSParamItem is None:
            ...
            strMessage = (
                "ERROR! XSParamList.setXSParamItem argument is not list but %s"
                % XSParamItem.__class__.__name__
            )
            raise BaseException(strMessage)

    def delXSParamItem(self):
        self._XSParamItem = None
    ...
    def addXSParamItem(self, value):
        if value is None:
            ...
            strMessage = (
                "ERROR! XSParamList.addXSParamItem argument is not XSParamItem but %s"
                % value.__class__.__name__
            )
            raise BaseException(strMessage)
...
class XSPluginItem(object):
    def __init__(self, name=None, XSParamList=None):
        if XSParamList is None:
            ...
            strMessage = (
                "ERROR! XSPluginItem constructor argument 'XSParamList' is not XSParamList but %s"
                % self._XSParamList.__class__.__name__
            )
            raise BaseException(strMessage)
        self._name = str(name)
    ...
    def setXSParamList(self, XSParamList):
        if XSParamList is None:
            ...
            strMessage = (
                "ERROR! XSPluginItem.setXSParamList argument is not XSParamList but %s"
                % XSParamList.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def buildChildren(self, child_, nodeName_):
        if child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "XSParamList":
            obj_ = XSParamList()
            obj_.build(child_)
...
class XSPluginList(object):
    def __init__(self, XSPluginItem=None):
        if XSPluginItem is None:
            ...
            strMessage = (
                "ERROR! XSPluginList constructor argument 'XSPluginItem' is not list but %s"
                % self._XSPluginItem.__class__.__name__
            )
            raise BaseException(strMessage)

    # Methods and properties for the 'XSPluginItem' attribute
    def getXSPluginItem(self):
        return self._XSPluginItem
    ...
    def setXSPluginItem(self, XSPluginItem):
        if XSPluginItem is None:
            ...
            strMessage = (
                "ERROR! XSPluginList.setXSPluginItem argument is not list but %s"
                % XSPluginItem.__class__.__name__
            )
            raise BaseException(strMessage)

    def delXSPluginItem(self):
        self._XSPluginItem = None
    ...
    def addXSPluginItem(self, value):
        if value is None:
            ...
            strMessage = (
                "ERROR! XSPluginList.addXSPluginItem argument is not XSPluginItem but %s"
                % value.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def insertXSPluginItem(self, index, value):
        if index is None:
            strMessage = (
                "ERROR! XSPluginList.insertXSPluginItem argument 'index' is None"
            )
            raise BaseException(strMessage)
        if value is None:
            strMessage = (
                "ERROR! XSPluginList.insertXSPluginItem argument 'value' is None"
            )
            raise BaseException(strMessage)
        elif value.__class__.__name__ == "XSPluginItem":
...
class XSDataArray(XSData):
    ...
    def __init__(
        ...
        if coding is None:
            ...
            strMessage = (
                "ERROR! XSDataArray constructor argument 'coding' is not XSDataString but %s"
                % self._coding.__class__.__name__
            )
            raise BaseException(strMessage)
        self._data = str(data)
        ...
        if md5sum is None:
            ...
            strMessage = (
                "ERROR! XSDataArray constructor argument 'md5sum' is not XSDataString but %s"
                % self._md5sum.__class__.__name__
            )
            raise BaseException(strMessage)
        if shape is None:
            self._shape = []
            ...
            strMessage = (
                "ERROR! XSDataArray constructor argument 'shape' is not list but %s"
    ...
    def setCoding(self, coding):
        if coding is None:
            ...
            strMessage = (
                "ERROR! XSDataArray.setCoding argument is not XSDataString but %s"
                % coding.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setMd5sum(self, md5sum):
        if md5sum is None:
            ...
            strMessage = (
                "ERROR! XSDataArray.setMd5sum argument is not XSDataString but %s"
                % md5sum.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setShape(self, shape):
        if shape is None:
            ...
            strMessage = (
                "ERROR! XSDataArray.setShape argument is not list but %s"
...
class XSDataFile(XSData):
    ...
    def __init__(self, path=None):
        ...
        if path is None:
            ...
            strMessage = (
                "ERROR! XSDataFile constructor argument 'path' is not XSDataString but %s"
                % self._path.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setPath(self, path):
        if path is None:
            ...
            strMessage = (
                "ERROR! XSDataFile.setPath argument is not XSDataString but %s"
...
class XSDataInput(XSData):
    ...
    def __init__(self, configuration=None):
        ...
        if configuration is None:
            ...
            strMessage = (
                "ERROR! XSDataInput constructor argument 'configuration' is not XSConfiguration but %s"
                % self._configuration.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setConfiguration(self, configuration):
        if configuration is None:
            ...
            strMessage = (
                "ERROR! XSDataInput.setConfiguration argument is not XSConfiguration but %s"
                % configuration.__class__.__name__
            )
            raise BaseException(strMessage)
...
class XSDataMessage(XSData):
    ...
    def __init__(self, type=None, text=None, level=None, debuginfo=None):
        ...
        if debuginfo is None:
            ...
            strMessage = (
                "ERROR! XSDataMessage constructor argument 'debuginfo' is not XSDataString but %s"
                % self._debuginfo.__class__.__name__
            )
            raise BaseException(strMessage)
        if level is None:
            self._level = None
            ...
            strMessage = (
                "ERROR! XSDataMessage constructor argument 'level' is not XSDataString but %s"
                % self._level.__class__.__name__
            )
            raise BaseException(strMessage)
        if text is None:
            self._text = None
            ...
            strMessage = (
                "ERROR! XSDataMessage constructor argument 'text' is not XSDataString but %s"
                % self._text.__class__.__name__
            )
            raise BaseException(strMessage)
        if type is None:
            self._type = None
            ...
            strMessage = (
                "ERROR! XSDataMessage constructor argument 'type' is not XSDataString but %s"
    ...
    def setDebuginfo(self, debuginfo):
        if debuginfo is None:
            ...
            strMessage = (
                "ERROR! XSDataMessage.setDebuginfo argument is not XSDataString but %s"
                % debuginfo.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setLevel(self, level):
        if level is None:
            ...
            strMessage = (
                "ERROR! XSDataMessage.setLevel argument is not XSDataString but %s"
    ...
    def setText(self, text):
        if text is None:
            ...
            strMessage = (
                "ERROR! XSDataMessage.setText argument is not XSDataString but %s"
    ...
    def setType(self, type):
        if type is None:
            ...
            strMessage = (
                "ERROR! XSDataMessage.setType argument is not XSDataString but %s"
...
class XSDataSize(XSData):
    ...
    def __init__(self, z=None, y=None, x=None):
        ...
        if x is None:
            ...
            strMessage = (
                "ERROR! XSDataSize constructor argument 'x' is not XSDataLength but %s"
        ...
        if y is None:
            ...
            strMessage = (
                "ERROR! XSDataSize constructor argument 'y' is not XSDataLength but %s"
        ...
        if z is None:
            ...
            strMessage = (
                "ERROR! XSDataSize constructor argument 'z' is not XSDataLength but %s"
                % self._z.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setX(self, x):
        if x is None:
            ...
            strMessage = (
                "ERROR! XSDataSize.setX argument is not XSDataLength but %s"
    ...
    def setY(self, y):
        if y is None:
            ...
            strMessage = (
                "ERROR! XSDataSize.setY argument is not XSDataLength but %s"
    ...
    def setZ(self, z):
        if z is None:
            ...
            strMessage = (
                "ERROR! XSDataSize.setZ argument is not XSDataLength but %s"
...
class XSDataStatus(XSData):
    ...
    def __init__(
        ...
        if executionInfo is None:
            ...
            strMessage = (
                "ERROR! XSDataStatus constructor argument 'executionInfo' is not XSDataExecutionInfo but %s"
                % self._executionInfo.__class__.__name__
            )
            raise BaseException(strMessage)
        if executiveSummary is None:
            ...
            strMessage = (
                "ERROR! XSDataStatus constructor argument 'executiveSummary' is not XSDataString but %s"
        ...
        if isSuccess is None:
            ...
            strMessage = (
                "ERROR! XSDataStatus constructor argument 'isSuccess' is not XSDataBoolean but %s"
                % self._isSuccess.__class__.__name__
            )
            raise BaseException(strMessage)
        if message is None:
            self._message = None
            ...
            strMessage = (
                "ERROR! XSDataStatus constructor argument 'message' is not XSDataMessage but %s"
    ...
    def setExecutionInfo(self, executionInfo):
        if executionInfo is None:
            ...
            strMessage = (
                "ERROR! XSDataStatus.setExecutionInfo argument is not XSDataExecutionInfo but %s"
                % executionInfo.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setExecutiveSummary(self, executiveSummary):
        if executiveSummary is None:
            ...
            strMessage = (
                "ERROR! XSDataStatus.setExecutiveSummary argument is not XSDataString but %s"
    ...
    def setIsSuccess(self, isSuccess):
        if isSuccess is None:
            ...
            strMessage = (
                "ERROR! XSDataStatus.setIsSuccess argument is not XSDataBoolean but %s"
                % isSuccess.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setMessage(self, message):
        if message is None:
            ...
            strMessage = (
                "ERROR! XSDataStatus.setMessage argument is not XSDataMessage but %s"
...
class XSDataResult(XSData):
    ...
    def __init__(self, status=None):
        ...
        if status is None:
            ...
            strMessage = (
                "ERROR! XSDataResult constructor argument 'status' is not XSDataStatus but %s"
                % self._status.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setStatus(self, status):
        if status is None:
            ...
            strMessage = (
                "ERROR! XSDataResult.setStatus argument is not XSDataStatus but %s"
...
class XSDataSysteminfo(XSData):
    ...
    def __init__(
        ...
        if compiler is None:
            ...
            strMessage = (
                "ERROR! XSDataSysteminfo constructor argument 'compiler' is not XSDataString but %s"
                % self._compiler.__class__.__name__
            )
            raise BaseException(strMessage)
        if hostIP is None:
            self._hostIP = None
            ...
            strMessage = (
                "ERROR! XSDataSysteminfo constructor argument 'hostIP' is not XSDataString but %s"
                % self._hostIP.__class__.__name__
            )
            raise BaseException(strMessage)
        if hostName is None:
            self._hostName = None
            ...
            strMessage = (
                "ERROR! XSDataSysteminfo constructor argument 'hostName' is not XSDataString but %s"
                % self._hostName.__class__.__name__
            )
            raise BaseException(strMessage)
        if operatingSystem is None:
            ...
            strMessage = (
                "ERROR! XSDataSysteminfo constructor argument 'operatingSystem' is not XSDataString but %s"
                % self._operatingSystem.__class__.__name__
            )
            raise BaseException(strMessage)
        if operatingSystemType is None:
            ...
            strMessage = (
                "ERROR! XSDataSysteminfo constructor argument 'operatingSystemType' is not XSDataString but %s"
                % self._operatingSystemType.__class__.__name__
            )
            raise BaseException(strMessage)
        if userName is None:
            self._userName = None
            ...
            strMessage = (
                "ERROR! XSDataSysteminfo constructor argument 'userName' is not XSDataString but %s"
                % self._userName.__class__.__name__
            )
            raise BaseException(strMessage)
        if virtualMachine is None:
            ...
            strMessage = (
                "ERROR! XSDataSysteminfo constructor argument 'virtualMachine' is not XSDataString but %s"
                % self._virtualMachine.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setCompiler(self, compiler):
        if compiler is None:
            ...
            strMessage = (
                "ERROR! XSDataSysteminfo.setCompiler argument is not XSDataString but %s"
    ...
    def setHostIP(self, hostIP):
        if hostIP is None:
            ...
            strMessage = (
                "ERROR! XSDataSysteminfo.setHostIP argument is not XSDataString but %s"
                % hostIP.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setHostName(self, hostName):
        if hostName is None:
            ...
            strMessage = (
                "ERROR! XSDataSysteminfo.setHostName argument is not XSDataString but %s"
    ...
    def setOperatingSystem(self, operatingSystem):
        if operatingSystem is None:
            ...
            strMessage = (
                "ERROR! XSDataSysteminfo.setOperatingSystem argument is not XSDataString but %s"
                % operatingSystem.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def getOperatingSystemType(self):
        return self._operatingSystemType
    ...
    def setOperatingSystemType(self, operatingSystemType):
        if operatingSystemType is None:
            ...
            strMessage = (
                "ERROR! XSDataSysteminfo.setOperatingSystemType argument is not XSDataString but %s"
                % operatingSystemType.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setUserName(self, userName):
        if userName is None:
            ...
            strMessage = (
                "ERROR! XSDataSysteminfo.setUserName argument is not XSDataString but %s"
                % userName.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setVirtualMachine(self, virtualMachine):
        if virtualMachine is None:
            ...
            strMessage = (
                "ERROR! XSDataSysteminfo.setVirtualMachine argument is not XSDataString but %s"
                % virtualMachine.__class__.__name__
            )
            raise BaseException(strMessage)
...
class XSDataDoubleWithUnit(XSDataDouble):
    def __init__(self, value=None, unit=None, error=None):
        ...
        if error is None:
            ...
            strMessage = (
                "ERROR! XSDataDoubleWithUnit constructor argument 'error' is not XSDataDouble but %s"
        ...
        if unit is None:
            ...
            strMessage = (
                "ERROR! XSDataDoubleWithUnit constructor argument 'unit' is not XSDataString but %s"
    ...
    def setError(self, error):
        if error is None:
            ...
            strMessage = (
                "ERROR! XSDataDoubleWithUnit.setError argument is not XSDataDouble but %s"
    ...
    def setUnit(self, unit):
        if unit is None:
            ...
            strMessage = (
                "ERROR! XSDataDoubleWithUnit.setUnit argument is not XSDataString but %s"
...
class XSDataImage(XSDataFile):
    ...
    def __init__(self, path=None, number=None, date=None):
        ...
        if date is None:
            ...
            strMessage = (
                "ERROR! XSDataImage constructor argument 'date' is not XSDataString but %s"
                % self._date.__class__.__name__
            )
            raise BaseException(strMessage)
        if number is None:
            self._number = None
            ...
            strMessage = (
                "ERROR! XSDataImage constructor argument 'number' is not XSDataInteger but %s"
    ...
    def setDate(self, date):
        if date is None:
            ...
            strMessage = (
                "ERROR! XSDataImage.setDate argument is not XSDataString but %s"
    ...
    def setNumber(self, number):
        if number is None:
            ...
            strMessage = (
                "ERROR! XSDataImage.setNumber argument is not XSDataInteger but %s"
...
class XSDataImageExt(XSDataImage):
    ...
    def __init__(
        ...
        if array is None:
            ...
            strMessage = (
                "ERROR! XSDataImageExt constructor argument 'array' is not XSDataArray but %s"
                % self._array.__class__.__name__
            )
            raise BaseException(strMessage)
        if exposureTime is None:
            ...
            strMessage = (
                "ERROR! XSDataImageExt constructor argument 'exposureTime' is not XSDataTime but %s"
        ...
        if shared is None:
            ...
            strMessage = (
                "ERROR! XSDataImageExt constructor argument 'shared' is not XSDataString but %s"
                % self._shared.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setArray(self, array):
        if array is None:
            ...
            strMessage = (
                "ERROR! XSDataImageExt.setArray argument is not XSDataArray but %s"
    ...
    def setExposureTime(self, exposureTime):
        if exposureTime is None:
            ...
            strMessage = (
                "ERROR! XSDataImageExt.setExposureTime argument is not XSDataTime but %s"
    ...
    def setShared(self, shared):
        if shared is None:
            ...
            strMessage = (
                "ERROR! XSDataImageExt.setShared argument is not XSDataString but %s"
                % shared.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def buildChildren(self, child_, nodeName_):
        if child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "array":
            obj_ = XSDataArray()
            obj_.build(child_)
            self.setArray(obj_)
        ...
        elif child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "shared":
            obj_ = XSDataString()
            obj_.build(child_)
            self.setShared(obj_)
    ...
    def outputFile(self, _outfileName):
        print(
            "WARNING: Method outputFile in class XSDataImageExt is deprecated, please use instead exportToFile!"
        )
        self.exportToFile(_outfileName)
