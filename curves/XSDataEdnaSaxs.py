...
class XSDataAutoRg(XSData):
    def __init__(
        ...
        if filename is None:
            ...
            strMessage = (
                "ERROR! XSDataAutoRg constructor argument 'filename' is not XSDataFile but %s"
                % self._filename.__class__.__name__
            )
        ...
        if rg is None:
            ...
            strMessage = (
                "ERROR! XSDataAutoRg constructor argument 'rg' is not XSDataLength but %s"
                % self._rg.__class__.__name__
            )
            raise BaseException(strMessage)
        if rgStdev is None:
            self._rgStdev = None
            ...
            strMessage = (
                "ERROR! XSDataAutoRg constructor argument 'rgStdev' is not XSDataLength but %s"
                % self._rgStdev.__class__.__name__
            )
            raise BaseException(strMessage)
        if i0 is None:
            self._i0 = None
            ...
            strMessage = (
                "ERROR! XSDataAutoRg constructor argument 'i0' is not XSDataDouble but %s"
                % self._i0.__class__.__name__
            )
            raise BaseException(strMessage)
        if i0Stdev is None:
            self._i0Stdev = None
            ...
            strMessage = (
                "ERROR! XSDataAutoRg constructor argument 'i0Stdev' is not XSDataDouble but %s"
                % self._i0Stdev.__class__.__name__
            )
            raise BaseException(strMessage)
        if firstPointUsed is None:
            ...
            strMessage = (
                "ERROR! XSDataAutoRg constructor argument 'firstPointUsed' is not XSDataInteger but %s"
                % self._firstPointUsed.__class__.__name__
            )
            raise BaseException(strMessage)
        if lastPointUsed is None:
            ...
            strMessage = (
                "ERROR! XSDataAutoRg constructor argument 'lastPointUsed' is not XSDataInteger but %s"
                % self._lastPointUsed.__class__.__name__
            )
            raise BaseException(strMessage)
        if quality is None:
            self._quality = None
            ...
            strMessage = (
                "ERROR! XSDataAutoRg constructor argument 'quality' is not XSDataDouble but %s"
                % self._quality.__class__.__name__
            )
            raise BaseException(strMessage)
        if isagregated is None:
            ...
            strMessage = (
                "ERROR! XSDataAutoRg constructor argument 'isagregated' is not XSDataBoolean but %s"
                % self._isagregated.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setFilename(self, filename):
        if filename is None:
            ...
            strMessage = (
                "ERROR! XSDataAutoRg.setFilename argument is not XSDataFile but %s"
    ...
    def setRg(self, rg):
        if rg is None:
            ...
            strMessage = (
                "ERROR! XSDataAutoRg.setRg argument is not XSDataLength but %s"
    ...
    def setRgStdev(self, rgStdev):
        if rgStdev is None:
            ...
            strMessage = (
                "ERROR! XSDataAutoRg.setRgStdev argument is not XSDataLength but %s"
                % rgStdev.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setI0(self, i0):
        if i0 is None:
            ...
            strMessage = (
                "ERROR! XSDataAutoRg.setI0 argument is not XSDataDouble but %s"
                % i0.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setI0Stdev(self, i0Stdev):
        if i0Stdev is None:
            ...
            strMessage = (
                "ERROR! XSDataAutoRg.setI0Stdev argument is not XSDataDouble but %s"
                % i0Stdev.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def getFirstPointUsed(self):
        return self._firstPointUsed
    ...
    def setFirstPointUsed(self, firstPointUsed):
        if firstPointUsed is None:
            ...
            strMessage = (
                "ERROR! XSDataAutoRg.setFirstPointUsed argument is not XSDataInteger but %s"
                % firstPointUsed.__class__.__name__
            )
            raise BaseException(strMessage)

    def delFirstPointUsed(self):
        self._firstPointUsed = None

    firstPointUsed = property(
        getFirstPointUsed,
        setFirstPointUsed,
        delFirstPointUsed,
        "Property for firstPointUsed",
    )
    # Methods and properties for the 'lastPointUsed' attribute
    def getLastPointUsed(self):
        return self._lastPointUsed
    ...
    def setLastPointUsed(self, lastPointUsed):
        if lastPointUsed is None:
            ...
            strMessage = (
                "ERROR! XSDataAutoRg.setLastPointUsed argument is not XSDataInteger but %s"
                % lastPointUsed.__class__.__name__
            )
            raise BaseException(strMessage)

    def delLastPointUsed(self):
        self._lastPointUsed = None

    lastPointUsed = property(
        getLastPointUsed,
        setLastPointUsed,
        delLastPointUsed,
        "Property for lastPointUsed",
    )
    ...
    def setQuality(self, quality):
        if quality is None:
            ...
            strMessage = (
                "ERROR! XSDataAutoRg.setQuality argument is not XSDataDouble but %s"
                % quality.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setIsagregated(self, isagregated):
        if isagregated is None:
            ...
            strMessage = (
                "ERROR! XSDataAutoRg.setIsagregated argument is not XSDataBoolean but %s"
                % isagregated.__class__.__name__
            )
            raise BaseException(strMessage)

    def delIsagregated(self):
        self._isagregated = None

    isagregated = property(
        getIsagregated, setIsagregated, delIsagregated, "Property for isagregated"
    )
    ...
    def buildChildren(self, child_, nodeName_):
        if child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "filename":
            obj_ = XSDataFile()
            obj_.build(child_)
            self.setFilename(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "rg":
            obj_ = XSDataLength()
            obj_.build(child_)
            self.setRg(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "rgStdev":
            obj_ = XSDataLength()
            obj_.build(child_)
            self.setRgStdev(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "i0":
            obj_ = XSDataDouble()
            obj_.build(child_)
            self.setI0(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "i0Stdev":
            obj_ = XSDataDouble()
            obj_.build(child_)
            self.setI0Stdev(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "firstPointUsed":
            obj_ = XSDataInteger()
            obj_.build(child_)
            self.setFirstPointUsed(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "lastPointUsed":
            obj_ = XSDataInteger()
            obj_.build(child_)
            self.setLastPointUsed(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "quality":
            obj_ = XSDataDouble()
            obj_.build(child_)
            self.setQuality(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "isagregated":
            obj_ = XSDataBoolean()
            obj_.build(child_)
    ...
    def outputFile(self, _outfileName):
        print(
            "WARNING: Method outputFile in class XSDataAutoRg is deprecated, please use instead exportToFile!"
        )
...
class XSDataBioSaxsSample(XSData):
    def __init__(self, temperature=None, code=None, comments=None, concentration=None):
        ...
        if temperature is None:
            ...
            strMessage = (
                "ERROR! XSDataBioSaxsSample constructor argument 'temperature' is not XSDataDouble but %s"
                % self._temperature.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setTemperature(self, temperature):
        if temperature is None:
            ...
            strMessage = (
                "ERROR! XSDataBioSaxsSample.setTemperature argument is not XSDataDouble but %s"
    ...
    temperature = property(
        getTemperature, setTemperature, delTemperature, "Property for temperature"
    )
    ...
    def buildChildren(self, child_, nodeName_):
        if child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "concentration":
            ...
            obj_.build(child_)
            self.setCode(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "temperature":
            obj_ = XSDataDouble()
            obj_.build(child_)
...
class XSDataConfigGnom(XSData):
    def __init__(
        ...
        if printer is None:
            ...
            strMessage = (
                "ERROR! XSDataConfigGnom constructor argument 'printer' is not list but %s"
                % self._printer.__class__.__name__
            )
            raise BaseException(strMessage)
        if forfac is None:
            self._forfac = None
            ...
            strMessage = (
                "ERROR! XSDataConfigGnom constructor argument 'forfac' is not XSDataFile but %s"
                % self._forfac.__class__.__name__
            )
            raise BaseException(strMessage)
        if expert is None:
            self._expert = None
            ...
            strMessage = (
                "ERROR! XSDataConfigGnom constructor argument 'expert' is not XSDataFile but %s"
                % self._expert.__class__.__name__
            )
            raise BaseException(strMessage)
        if input1 is None:
            self._input1 = None
            ...
            strMessage = (
                "ERROR! XSDataConfigGnom constructor argument 'input1' is not XSDataFile but %s"
                % self._input1.__class__.__name__
            )
            raise BaseException(strMessage)
        if input2 is None:
            self._input2 = None
            ...
            strMessage = (
                "ERROR! XSDataConfigGnom constructor argument 'input2' is not XSDataFile but %s"
                % self._input2.__class__.__name__
            )
            raise BaseException(strMessage)
        if nskip1 is None:
            self._nskip1 = None
            ...
            strMessage = (
                "ERROR! XSDataConfigGnom constructor argument 'nskip1' is not XSDataInteger but %s"
                % self._nskip1.__class__.__name__
            )
            raise BaseException(strMessage)
        if nskip2 is None:
            self._nskip2 = None
            ...
            strMessage = (
                "ERROR! XSDataConfigGnom constructor argument 'nskip2' is not XSDataInteger but %s"
                % self._nskip2.__class__.__name__
            )
            raise BaseException(strMessage)
        if output is None:
            self._output = None
            ...
            strMessage = (
                "ERROR! XSDataConfigGnom constructor argument 'output' is not XSDataFile but %s"
                % self._output.__class__.__name__
            )
            raise BaseException(strMessage)
        if iscale is None:
            self._iscale = None
            ...
            strMessage = (
                "ERROR! XSDataConfigGnom constructor argument 'iscale' is not XSDataInteger but %s"
                % self._iscale.__class__.__name__
            )
            raise BaseException(strMessage)
        if plonp is None:
            self._plonp = None
            ...
            strMessage = (
                "ERROR! XSDataConfigGnom constructor argument 'plonp' is not XSDataBoolean but %s"
                % self._plonp.__class__.__name__
            )
            raise BaseException(strMessage)
        if plores is None:
            self._plores = None
            ...
            strMessage = (
                "ERROR! XSDataConfigGnom constructor argument 'plores' is not XSDataBoolean but %s"
                % self._plores.__class__.__name__
            )
            raise BaseException(strMessage)
        if evaerr is None:
            self._evaerr = None
            ...
            strMessage = (
                "ERROR! XSDataConfigGnom constructor argument 'evaerr' is not XSDataBoolean but %s"
                % self._evaerr.__class__.__name__
            )
            raise BaseException(strMessage)
        if ploerr is None:
            self._ploerr = None
            ...
            strMessage = (
                "ERROR! XSDataConfigGnom constructor argument 'ploerr' is not XSDataBoolean but %s"
                % self._ploerr.__class__.__name__
            )
            raise BaseException(strMessage)
        if lkern is None:
            self._lkern = None
            ...
            strMessage = (
                "ERROR! XSDataConfigGnom constructor argument 'lkern' is not XSDataBoolean but %s"
                % self._lkern.__class__.__name__
            )
            raise BaseException(strMessage)
        if jobtyp is None:
            self._jobtyp = None
            ...
            strMessage = (
                "ERROR! XSDataConfigGnom constructor argument 'jobtyp' is not XSDataInteger but %s"
                % self._jobtyp.__class__.__name__
            )
            raise BaseException(strMessage)
        if rmin is None:
            self._rmin = None
            ...
            strMessage = (
                "ERROR! XSDataConfigGnom constructor argument 'rmin' is not XSDataDouble but %s"
                % self._rmin.__class__.__name__
            )
            raise BaseException(strMessage)
        if rmax is None:
            self._rmax = None
            ...
            strMessage = (
                "ERROR! XSDataConfigGnom constructor argument 'rmax' is not XSDataDouble but %s"
                % self._rmax.__class__.__name__
            )
            raise BaseException(strMessage)
        if lzrmin is None:
            self._lzrmin = None
            ...
            strMessage = (
                "ERROR! XSDataConfigGnom constructor argument 'lzrmin' is not XSDataBoolean but %s"
                % self._lzrmin.__class__.__name__
            )
            raise BaseException(strMessage)
        if lzrmax is None:
            self._lzrmax = None
            ...
            strMessage = (
                "ERROR! XSDataConfigGnom constructor argument 'lzrmax' is not XSDataBoolean but %s"
                % self._lzrmax.__class__.__name__
            )
            raise BaseException(strMessage)
        if kernel is None:
            self._kernel = None
            ...
            strMessage = (
                "ERROR! XSDataConfigGnom constructor argument 'kernel' is not XSDataFile but %s"
        ...
        if deviat is None:
            ...
            strMessage = (
                "ERROR! XSDataConfigGnom constructor argument 'deviat' is not XSDataDouble but %s"
                % self._deviat.__class__.__name__
            )
            raise BaseException(strMessage)
        if idet is None:
            self._idet = None
            ...
            strMessage = (
                "ERROR! XSDataConfigGnom constructor argument 'idet' is not XSDataInteger but %s"
                % self._idet.__class__.__name__
            )
            raise BaseException(strMessage)
        if fwhm1 is None:
            self._fwhm1 = None
            ...
            strMessage = (
                "ERROR! XSDataConfigGnom constructor argument 'fwhm1' is not XSDataDouble but %s"
                % self._fwhm1.__class__.__name__
            )
            raise BaseException(strMessage)
        if fwhm2 is None:
            self._fwhm2 = None
            ...
            strMessage = (
                "ERROR! XSDataConfigGnom constructor argument 'fwhm2' is not XSDataDouble but %s"
                % self._fwhm2.__class__.__name__
            )
            raise BaseException(strMessage)
        if ah1 is None:
            self._ah1 = None
            ...
            strMessage = (
                "ERROR! XSDataConfigGnom constructor argument 'ah1' is not XSDataDouble but %s"
                % self._ah1.__class__.__name__
            )
            raise BaseException(strMessage)
        if lh1 is None:
            self._lh1 = None
            ...
            strMessage = (
                "ERROR! XSDataConfigGnom constructor argument 'lh1' is not XSDataDouble but %s"
                % self._lh1.__class__.__name__
            )
            raise BaseException(strMessage)
        if aw1 is None:
            self._aw1 = None
            ...
            strMessage = (
                "ERROR! XSDataConfigGnom constructor argument 'aw1' is not XSDataDouble but %s"
                % self._aw1.__class__.__name__
            )
            raise BaseException(strMessage)
        if lw1 is None:
            self._lw1 = None
            ...
            strMessage = (
                "ERROR! XSDataConfigGnom constructor argument 'lw1' is not XSDataDouble but %s"
                % self._lw1.__class__.__name__
            )
            raise BaseException(strMessage)
        if ah2 is None:
            self._ah2 = None
            ...
            strMessage = (
                "ERROR! XSDataConfigGnom constructor argument 'ah2' is not XSDataDouble but %s"
                % self._ah2.__class__.__name__
            )
            raise BaseException(strMessage)
        if lh2 is None:
            self._lh2 = None
            ...
            strMessage = (
                "ERROR! XSDataConfigGnom constructor argument 'lh2' is not XSDataDouble but %s"
                % self._lh2.__class__.__name__
            )
            raise BaseException(strMessage)
        if aw2 is None:
            self._aw2 = None
            ...
            strMessage = (
                "ERROR! XSDataConfigGnom constructor argument 'aw2' is not XSDataDouble but %s"
                % self._aw2.__class__.__name__
            )
            raise BaseException(strMessage)
        if lw2 is None:
            self._lw2 = None
            ...
            strMessage = (
                "ERROR! XSDataConfigGnom constructor argument 'lw2' is not XSDataDouble but %s"
                % self._lw2.__class__.__name__
            )
            raise BaseException(strMessage)
        if spot1 is None:
            self._spot1 = None
            ...
            strMessage = (
                "ERROR! XSDataConfigGnom constructor argument 'spot1' is not XSDataFile but %s"
                % self._spot1.__class__.__name__
            )
            raise BaseException(strMessage)
        if spot2 is None:
            self._spot2 = None
            ...
            strMessage = (
                "ERROR! XSDataConfigGnom constructor argument 'spot2' is not XSDataFile but %s"
                % self._spot2.__class__.__name__
            )
            raise BaseException(strMessage)
        if alpha is None:
            self._alpha = None
            ...
            strMessage = (
                "ERROR! XSDataConfigGnom constructor argument 'alpha' is not XSDataDouble but %s"
                % self._alpha.__class__.__name__
            )
            raise BaseException(strMessage)
        if nreal is None:
            self._nreal = None
            ...
            strMessage = (
                "ERROR! XSDataConfigGnom constructor argument 'nreal' is not XSDataInteger but %s"
                % self._nreal.__class__.__name__
            )
            raise BaseException(strMessage)
        if coef is None:
            self._coef = None
            ...
            strMessage = (
                "ERROR! XSDataConfigGnom constructor argument 'coef' is not XSDataDouble but %s"
                % self._coef.__class__.__name__
            )
            raise BaseException(strMessage)
        if rad56 is None:
            self._rad56 = None
            ...
            strMessage = (
                "ERROR! XSDataConfigGnom constructor argument 'rad56' is not XSDataDouble but %s"
                % self._rad56.__class__.__name__
            )
            raise BaseException(strMessage)
        if nextjob is None:
            self._nextjob = None
            ...
            strMessage = (
                "ERROR! XSDataConfigGnom constructor argument 'nextjob' is not XSDataBoolean but %s"
                % self._nextjob.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setPrinter(self, printer):
        if printer is None:
            ...
            strMessage = (
                "ERROR! XSDataConfigGnom.setPrinter argument is not list but %s"
                % printer.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def addPrinter(self, value):
        if value is None:
            ...
            strMessage = (
                "ERROR! XSDataConfigGnom.addPrinter argument is not XSDataString but %s"
    ...
    def insertPrinter(self, index, value):
        if index is None:
            strMessage = (
                "ERROR! XSDataConfigGnom.insertPrinter argument 'index' is None"
            )
            raise BaseException(strMessage)
        if value is None:
            strMessage = (
                "ERROR! XSDataConfigGnom.insertPrinter argument 'value' is None"
            )
            raise BaseException(strMessage)
        elif value.__class__.__name__ == "XSDataString":
    ...
    def setForfac(self, forfac):
        if forfac is None:
            ...
            strMessage = (
                "ERROR! XSDataConfigGnom.setForfac argument is not XSDataFile but %s"
                % forfac.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setExpert(self, expert):
        if expert is None:
            ...
            strMessage = (
                "ERROR! XSDataConfigGnom.setExpert argument is not XSDataFile but %s"
    ...
    def setInput1(self, input1):
        if input1 is None:
            ...
            strMessage = (
                "ERROR! XSDataConfigGnom.setInput1 argument is not XSDataFile but %s"
                % input1.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setInput2(self, input2):
        if input2 is None:
            ...
            strMessage = (
                "ERROR! XSDataConfigGnom.setInput2 argument is not XSDataFile but %s"
                % input2.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setNskip1(self, nskip1):
        if nskip1 is None:
            ...
            strMessage = (
                "ERROR! XSDataConfigGnom.setNskip1 argument is not XSDataInteger but %s"
                % nskip1.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setNskip2(self, nskip2):
        if nskip2 is None:
            ...
            strMessage = (
                "ERROR! XSDataConfigGnom.setNskip2 argument is not XSDataInteger but %s"
                % nskip2.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setOutput(self, output):
        if output is None:
            ...
            strMessage = (
                "ERROR! XSDataConfigGnom.setOutput argument is not XSDataFile but %s"
    ...
    def setIscale(self, iscale):
        if iscale is None:
            ...
            strMessage = (
                "ERROR! XSDataConfigGnom.setIscale argument is not XSDataInteger but %s"
                % iscale.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setPlonp(self, plonp):
        if plonp is None:
            ...
            strMessage = (
                "ERROR! XSDataConfigGnom.setPlonp argument is not XSDataBoolean but %s"
                % plonp.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setPlores(self, plores):
        if plores is None:
            ...
            strMessage = (
                "ERROR! XSDataConfigGnom.setPlores argument is not XSDataBoolean but %s"
                % plores.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setEvaerr(self, evaerr):
        if evaerr is None:
            ...
            strMessage = (
                "ERROR! XSDataConfigGnom.setEvaerr argument is not XSDataBoolean but %s"
                % evaerr.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setPloerr(self, ploerr):
        if ploerr is None:
            ...
            strMessage = (
                "ERROR! XSDataConfigGnom.setPloerr argument is not XSDataBoolean but %s"
                % ploerr.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setLkern(self, lkern):
        if lkern is None:
            ...
            strMessage = (
                "ERROR! XSDataConfigGnom.setLkern argument is not XSDataBoolean but %s"
                % lkern.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setJobtyp(self, jobtyp):
        if jobtyp is None:
            ...
            strMessage = (
                "ERROR! XSDataConfigGnom.setJobtyp argument is not XSDataInteger but %s"
                % jobtyp.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setRmin(self, rmin):
        if rmin is None:
            ...
            strMessage = (
                "ERROR! XSDataConfigGnom.setRmin argument is not XSDataDouble but %s"
                % rmin.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setRmax(self, rmax):
        if rmax is None:
            ...
            strMessage = (
                "ERROR! XSDataConfigGnom.setRmax argument is not XSDataDouble but %s"
                % rmax.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setLzrmin(self, lzrmin):
        if lzrmin is None:
            ...
            strMessage = (
                "ERROR! XSDataConfigGnom.setLzrmin argument is not XSDataBoolean but %s"
                % lzrmin.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setLzrmax(self, lzrmax):
        if lzrmax is None:
            ...
            strMessage = (
                "ERROR! XSDataConfigGnom.setLzrmax argument is not XSDataBoolean but %s"
                % lzrmax.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setKernel(self, kernel):
        if kernel is None:
            ...
            strMessage = (
                "ERROR! XSDataConfigGnom.setKernel argument is not XSDataFile but %s"
    ...
    def setDeviat(self, deviat):
        if deviat is None:
            ...
            strMessage = (
                "ERROR! XSDataConfigGnom.setDeviat argument is not XSDataDouble but %s"
                % deviat.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setIdet(self, idet):
        if idet is None:
            ...
            strMessage = (
                "ERROR! XSDataConfigGnom.setIdet argument is not XSDataInteger but %s"
                % idet.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setFwhm1(self, fwhm1):
        if fwhm1 is None:
            ...
            strMessage = (
                "ERROR! XSDataConfigGnom.setFwhm1 argument is not XSDataDouble but %s"
                % fwhm1.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setFwhm2(self, fwhm2):
        if fwhm2 is None:
            ...
            strMessage = (
                "ERROR! XSDataConfigGnom.setFwhm2 argument is not XSDataDouble but %s"
                % fwhm2.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setAh1(self, ah1):
        if ah1 is None:
            ...
            strMessage = (
                "ERROR! XSDataConfigGnom.setAh1 argument is not XSDataDouble but %s"
                % ah1.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setLh1(self, lh1):
        if lh1 is None:
            ...
            strMessage = (
                "ERROR! XSDataConfigGnom.setLh1 argument is not XSDataDouble but %s"
                % lh1.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setAw1(self, aw1):
        if aw1 is None:
            ...
            strMessage = (
                "ERROR! XSDataConfigGnom.setAw1 argument is not XSDataDouble but %s"
                % aw1.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setLw1(self, lw1):
        if lw1 is None:
            ...
            strMessage = (
                "ERROR! XSDataConfigGnom.setLw1 argument is not XSDataDouble but %s"
                % lw1.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setAh2(self, ah2):
        if ah2 is None:
            ...
            strMessage = (
                "ERROR! XSDataConfigGnom.setAh2 argument is not XSDataDouble but %s"
                % ah2.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setLh2(self, lh2):
        if lh2 is None:
            ...
            strMessage = (
                "ERROR! XSDataConfigGnom.setLh2 argument is not XSDataDouble but %s"
                % lh2.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setAw2(self, aw2):
        if aw2 is None:
            ...
            strMessage = (
                "ERROR! XSDataConfigGnom.setAw2 argument is not XSDataDouble but %s"
                % aw2.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setLw2(self, lw2):
        if lw2 is None:
            ...
            strMessage = (
                "ERROR! XSDataConfigGnom.setLw2 argument is not XSDataDouble but %s"
                % lw2.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setSpot1(self, spot1):
        if spot1 is None:
            ...
            strMessage = (
                "ERROR! XSDataConfigGnom.setSpot1 argument is not XSDataFile but %s"
                % spot1.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setSpot2(self, spot2):
        if spot2 is None:
            ...
            strMessage = (
                "ERROR! XSDataConfigGnom.setSpot2 argument is not XSDataFile but %s"
                % spot2.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setAlpha(self, alpha):
        if alpha is None:
            ...
            strMessage = (
                "ERROR! XSDataConfigGnom.setAlpha argument is not XSDataDouble but %s"
                % alpha.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setNreal(self, nreal):
        if nreal is None:
            ...
            strMessage = (
                "ERROR! XSDataConfigGnom.setNreal argument is not XSDataInteger but %s"
                % nreal.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setCoef(self, coef):
        if coef is None:
            ...
            strMessage = (
                "ERROR! XSDataConfigGnom.setCoef argument is not XSDataDouble but %s"
                % coef.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setRad56(self, rad56):
        if rad56 is None:
            ...
            strMessage = (
                "ERROR! XSDataConfigGnom.setRad56 argument is not XSDataDouble but %s"
                % rad56.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setNextjob(self, nextjob):
        if nextjob is None:
            ...
            strMessage = (
                "ERROR! XSDataConfigGnom.setNextjob argument is not XSDataBoolean but %s"
                % nextjob.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def buildChildren(self, child_, nodeName_):
        if child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "printer":
            obj_ = XSDataString()
            obj_.build(child_)
            self.printer.append(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "forfac":
            obj_ = XSDataFile()
            obj_.build(child_)
            self.setForfac(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "expert":
            obj_ = XSDataFile()
            obj_.build(child_)
            self.setExpert(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "input1":
            obj_ = XSDataFile()
            obj_.build(child_)
            self.setInput1(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "input2":
            obj_ = XSDataFile()
            obj_.build(child_)
            self.setInput2(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "nskip1":
            obj_ = XSDataInteger()
            obj_.build(child_)
            self.setNskip1(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "nskip2":
            obj_ = XSDataInteger()
            obj_.build(child_)
            self.setNskip2(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "output":
            obj_ = XSDataFile()
            obj_.build(child_)
            self.setOutput(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "iscale":
            obj_ = XSDataInteger()
            obj_.build(child_)
            self.setIscale(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "plonp":
            obj_ = XSDataBoolean()
            obj_.build(child_)
            self.setPlonp(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "plores":
            obj_ = XSDataBoolean()
            obj_.build(child_)
            self.setPlores(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "evaerr":
            obj_ = XSDataBoolean()
            obj_.build(child_)
            self.setEvaerr(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "ploerr":
            obj_ = XSDataBoolean()
            obj_.build(child_)
            self.setPloerr(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "lkern":
            obj_ = XSDataBoolean()
            obj_.build(child_)
            self.setLkern(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "jobtyp":
            obj_ = XSDataInteger()
            obj_.build(child_)
            self.setJobtyp(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "rmin":
            obj_ = XSDataDouble()
            obj_.build(child_)
            self.setRmin(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "rmax":
            obj_ = XSDataDouble()
            obj_.build(child_)
            self.setRmax(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "lzrmin":
            obj_ = XSDataBoolean()
            obj_.build(child_)
            self.setLzrmin(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "lzrmax":
            obj_ = XSDataBoolean()
            obj_.build(child_)
            self.setLzrmax(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "kernel":
            obj_ = XSDataFile()
            obj_.build(child_)
            self.setKernel(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "deviat":
            obj_ = XSDataDouble()
            obj_.build(child_)
            self.setDeviat(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "idet":
            obj_ = XSDataInteger()
            obj_.build(child_)
            self.setIdet(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "fwhm1":
            obj_ = XSDataDouble()
            obj_.build(child_)
            self.setFwhm1(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "fwhm2":
            obj_ = XSDataDouble()
            obj_.build(child_)
            self.setFwhm2(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "ah1":
            obj_ = XSDataDouble()
            obj_.build(child_)
            self.setAh1(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "lh1":
            obj_ = XSDataDouble()
            obj_.build(child_)
            self.setLh1(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "aw1":
            obj_ = XSDataDouble()
            obj_.build(child_)
            self.setAw1(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "lw1":
            obj_ = XSDataDouble()
            obj_.build(child_)
            self.setLw1(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "ah2":
            obj_ = XSDataDouble()
            obj_.build(child_)
            self.setAh2(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "lh2":
            obj_ = XSDataDouble()
            obj_.build(child_)
            self.setLh2(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "aw2":
            obj_ = XSDataDouble()
            obj_.build(child_)
            self.setAw2(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "lw2":
            obj_ = XSDataDouble()
            obj_.build(child_)
            self.setLw2(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "spot1":
            obj_ = XSDataFile()
            obj_.build(child_)
            self.setSpot1(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "spot2":
            obj_ = XSDataFile()
            obj_.build(child_)
            self.setSpot2(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "alpha":
            obj_ = XSDataDouble()
            obj_.build(child_)
            self.setAlpha(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "nreal":
            obj_ = XSDataInteger()
            obj_.build(child_)
            self.setNreal(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "coef":
            obj_ = XSDataDouble()
            obj_.build(child_)
            self.setCoef(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "rad56":
            obj_ = XSDataDouble()
            obj_.build(child_)
            self.setRad56(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "nextjob":
            obj_ = XSDataBoolean()
            obj_.build(child_)
    ...
    def outputFile(self, _outfileName):
        print(
            "WARNING: Method outputFile in class XSDataConfigGnom is deprecated, please use instead exportToFile!"
        )
        self.exportToFile(_outfileName)
...
class XSDataGnom(XSData):
    def __init__(
        self, total=None, dmax=None, rgGnom=None, rgGuinier=None, gnomFile=None
    ):
        XSData.__init__(
            self,
        )
        if gnomFile is None:
            ...
            strMessage = (
                "ERROR! XSDataGnom constructor argument 'gnomFile' is not XSDataFile but %s"
        ...
        if rgGuinier is None:
            ...
            strMessage = (
                "ERROR! XSDataGnom constructor argument 'rgGuinier' is not XSDataLength but %s"
                % self._rgGuinier.__class__.__name__
            )
            raise BaseException(strMessage)
        if rgGnom is None:
            self._rgGnom = None
            ...
            strMessage = (
                "ERROR! XSDataGnom constructor argument 'rgGnom' is not XSDataLength but %s"
                % self._rgGnom.__class__.__name__
            )
            raise BaseException(strMessage)
        if dmax is None:
            self._dmax = None
            ...
            strMessage = (
                "ERROR! XSDataGnom constructor argument 'dmax' is not XSDataLength but %s"
                % self._dmax.__class__.__name__
            )
            raise BaseException(strMessage)
        if total is None:
            self._total = None
            ...
            strMessage = (
                "ERROR! XSDataGnom constructor argument 'total' is not XSDataDouble but %s"
                % self._total.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setGnomFile(self, gnomFile):
        if gnomFile is None:
            ...
            strMessage = (
                "ERROR! XSDataGnom.setGnomFile argument is not XSDataFile but %s"
    ...
    def getRgGuinier(self):
        return self._rgGuinier
    ...
    def setRgGuinier(self, rgGuinier):
        if rgGuinier is None:
            ...
            strMessage = (
                "ERROR! XSDataGnom.setRgGuinier argument is not XSDataLength but %s"
                % rgGuinier.__class__.__name__
            )
            raise BaseException(strMessage)

    def delRgGuinier(self):
        self._rgGuinier = None

    rgGuinier = property(
        getRgGuinier, setRgGuinier, delRgGuinier, "Property for rgGuinier"
    )
    ...
    def setRgGnom(self, rgGnom):
        if rgGnom is None:
            ...
            strMessage = (
                "ERROR! XSDataGnom.setRgGnom argument is not XSDataLength but %s"
                % rgGnom.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setDmax(self, dmax):
        if dmax is None:
            ...
            strMessage = (
                "ERROR! XSDataGnom.setDmax argument is not XSDataLength but %s"
                % dmax.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setTotal(self, total):
        if total is None:
            ...
            strMessage = (
                "ERROR! XSDataGnom.setTotal argument is not XSDataDouble but %s"
                % total.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def buildChildren(self, child_, nodeName_):
        if child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "gnomFile":
            obj_ = XSDataFile()
            obj_.build(child_)
            self.setGnomFile(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "rgGuinier":
            obj_ = XSDataLength()
            obj_.build(child_)
            self.setRgGuinier(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "rgGnom":
            obj_ = XSDataLength()
            obj_.build(child_)
            self.setRgGnom(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "dmax":
            obj_ = XSDataLength()
            obj_.build(child_)
            self.setDmax(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "total":
            obj_ = XSDataDouble()
            obj_.build(child_)
            self.setTotal(obj_)
        XSData.buildChildren(self, child_, nodeName_)
    ...
    def outputFile(self, _outfileName):
        print(
            "WARNING: Method outputFile in class XSDataGnom is deprecated, please use instead exportToFile!"
        )
        self.exportToFile(_outfileName)
...
class XSDataSaxsModel(XSData):
    ...
    def __init__(
        ...
        if name is None:
            ...
            strMessage = (
                "ERROR! XSDataSaxsModel constructor argument 'name' is not XSDataString but %s"
        ...
        if pdbFile is None:
            ...
            strMessage = (
                "ERROR! XSDataSaxsModel constructor argument 'pdbFile' is not XSDataFile but %s"
                % self._pdbFile.__class__.__name__
            )
            raise BaseException(strMessage)
        if fitFile is None:
            self._fitFile = None
            ...
            strMessage = (
                "ERROR! XSDataSaxsModel constructor argument 'fitFile' is not XSDataFile but %s"
        ...
        if firFile is None:
            ...
            strMessage = (
                "ERROR! XSDataSaxsModel constructor argument 'firFile' is not XSDataFile but %s"
                % self._firFile.__class__.__name__
            )
            raise BaseException(strMessage)
        if logFile is None:
            self._logFile = None
            ...
            strMessage = (
                "ERROR! XSDataSaxsModel constructor argument 'logFile' is not XSDataFile but %s"
        ...
        if rfactor is None:
            ...
            strMessage = (
                "ERROR! XSDataSaxsModel constructor argument 'rfactor' is not XSDataDouble but %s"
        ...
        if chiSqrt is None:
            ...
            strMessage = (
                "ERROR! XSDataSaxsModel constructor argument 'chiSqrt' is not XSDataDouble but %s"
                % self._chiSqrt.__class__.__name__
            )
            raise BaseException(strMessage)
        if volume is None:
            self._volume = None
            ...
            strMessage = (
                "ERROR! XSDataSaxsModel constructor argument 'volume' is not XSDataDouble but %s"
        ...
        if rg is None:
            ...
            strMessage = (
                "ERROR! XSDataSaxsModel constructor argument 'rg' is not XSDataDouble but %s"
                % self._rg.__class__.__name__
            )
            raise BaseException(strMessage)
        if dmax is None:
            ...
            strMessage = (
                "ERROR! XSDataSaxsModel constructor argument 'dmax' is not XSDataDouble but %s"
                % self._dmax.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setName(self, name):
        if name is None:
            ...
            strMessage = (
                "ERROR! XSDataSaxsModel.setName argument is not XSDataString but %s"
    ...
    def setPdbFile(self, pdbFile):
        if pdbFile is None:
            ...
            strMessage = (
                "ERROR! XSDataSaxsModel.setPdbFile argument is not XSDataFile but %s"
                % pdbFile.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setFitFile(self, fitFile):
        if fitFile is None:
            ...
            strMessage = (
                "ERROR! XSDataSaxsModel.setFitFile argument is not XSDataFile but %s"
    ...
    def setFirFile(self, firFile):
        if firFile is None:
            ...
            strMessage = (
                "ERROR! XSDataSaxsModel.setFirFile argument is not XSDataFile but %s"
                % firFile.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setLogFile(self, logFile):
        if logFile is None:
            ...
            strMessage = (
                "ERROR! XSDataSaxsModel.setLogFile argument is not XSDataFile but %s"
    ...
    def setRfactor(self, rfactor):
        if rfactor is None:
            ...
            strMessage = (
                "ERROR! XSDataSaxsModel.setRfactor argument is not XSDataDouble but %s"
    ...
    def setChiSqrt(self, chiSqrt):
        if chiSqrt is None:
            ...
            strMessage = (
                "ERROR! XSDataSaxsModel.setChiSqrt argument is not XSDataDouble but %s"
                % chiSqrt.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setVolume(self, volume):
        if volume is None:
            ...
            strMessage = (
                "ERROR! XSDataSaxsModel.setVolume argument is not XSDataDouble but %s"
    ...
    def setRg(self, rg):
        if rg is None:
            ...
            strMessage = (
                "ERROR! XSDataSaxsModel.setRg argument is not XSDataDouble but %s"
                % rg.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setDmax(self, dmax):
        if dmax is None:
            ...
            strMessage = (
                "ERROR! XSDataSaxsModel.setDmax argument is not XSDataDouble but %s"
                % dmax.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def buildChildren(self, child_, nodeName_):
        if child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "name":
            ...
            obj_.build(child_)
            self.setName(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "pdbFile":
            obj_ = XSDataFile()
            obj_.build(child_)
        ...
        elif child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "firFile":
            obj_ = XSDataFile()
            obj_.build(child_)
        ...
        elif child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "chiSqrt":
            obj_ = XSDataDouble()
            obj_.build(child_)
    ...
    def outputFile(self, _outfileName):
        print(
            "WARNING: Method outputFile in class XSDataSaxsModel is deprecated, please use instead exportToFile!"
        )
        self.exportToFile(_outfileName)
...
class XSDataSaxsSample(XSData):
    ...
    def __init__(self, code=None, comment=None, name=None):
        ...
        if name is None:
            ...
            strMessage = (
                "ERROR! XSDataSaxsSample constructor argument 'name' is not XSDataString but %s"
                % self._name.__class__.__name__
            )
            raise BaseException(strMessage)
        if comment is None:
            ...
            strMessage = (
                "ERROR! XSDataSaxsSample constructor argument 'comment' is not XSDataString but %s"
        ...
        if code is None:
            ...
            strMessage = (
                "ERROR! XSDataSaxsSample constructor argument 'code' is not XSDataString but %s"
                % self._code.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setName(self, name):
        if name is None:
            ...
            strMessage = (
                "ERROR! XSDataSaxsSample.setName argument is not XSDataString but %s"
                % name.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setComment(self, comment):
        if comment is None:
            ...
            strMessage = (
                "ERROR! XSDataSaxsSample.setComment argument is not XSDataString but %s"
    ...
    def setCode(self, code):
        if code is None:
            ...
            strMessage = (
                "ERROR! XSDataSaxsSample.setCode argument is not XSDataString but %s"
                % code.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def outputFile(self, _outfileName):
        print(
            "WARNING: Method outputFile in class XSDataSaxsSample is deprecated, please use instead exportToFile!"
        )
        self.exportToFile(_outfileName)
...
class XSDataSaxsSeries(XSData):
    ...
    def __init__(self, concentration=None, curve=None):
        ...
        if curve is None:
            ...
            strMessage = (
                "ERROR! XSDataSaxsSeries constructor argument 'curve' is not XSDataFile but %s"
                % self._curve.__class__.__name__
            )
            raise BaseException(strMessage)
        if concentration is None:
            self._concentration = None
            ...
            strMessage = (
                "ERROR! XSDataSaxsSeries constructor argument 'concentration' is not XSDataDouble but %s"
                % self._concentration.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setCurve(self, curve):
        if curve is None:
            ...
            strMessage = (
                "ERROR! XSDataSaxsSeries.setCurve argument is not XSDataFile but %s"
    ...
    def setConcentration(self, concentration):
        if concentration is None:
            ...
            strMessage = (
                "ERROR! XSDataSaxsSeries.setConcentration argument is not XSDataDouble but %s"
                % concentration.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def buildChildren(self, child_, nodeName_):
        if child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "curve":
            obj_ = XSDataFile()
            obj_.build(child_)
            self.setCurve(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "concentration":
            obj_ = XSDataDouble()
            obj_.build(child_)
            self.setConcentration(obj_)
        XSData.buildChildren(self, child_, nodeName_)
    ...
    def outputFile(self, _outfileName):
        print(
            "WARNING: Method outputFile in class XSDataSaxsSeries is deprecated, please use instead exportToFile!"
        )
        self.exportToFile(_outfileName)
...
class XSDataInputAutoRg(XSDataInput):
    def __init__(
        ...
        if sample is None:
            ...
            strMessage = (
                "ERROR! XSDataInputAutoRg constructor argument 'sample' is not XSDataSaxsSample but %s"
        ...
        if inputCurve is None:
            ...
            strMessage = (
                "ERROR! XSDataInputAutoRg constructor argument 'inputCurve' is not list but %s"
                % self._inputCurve.__class__.__name__
            )
            raise BaseException(strMessage)
        if minIntervalLength is None:
            ...
            strMessage = (
                "ERROR! XSDataInputAutoRg constructor argument 'minIntervalLength' is not XSDataInteger but %s"
                % self._minIntervalLength.__class__.__name__
            )
            raise BaseException(strMessage)
        if maxSmaxRg is None:
            ...
            strMessage = (
                "ERROR! XSDataInputAutoRg constructor argument 'maxSmaxRg' is not XSDataDouble but %s"
                % self._maxSmaxRg.__class__.__name__
            )
            raise BaseException(strMessage)
        if maxSminRg is None:
            ...
            strMessage = (
                "ERROR! XSDataInputAutoRg constructor argument 'maxSminRg' is not XSDataDouble but %s"
                % self._maxSminRg.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setSample(self, sample):
        if sample is None:
            ...
            strMessage = (
                "ERROR! XSDataInputAutoRg.setSample argument is not XSDataSaxsSample but %s"
    ...
    def setInputCurve(self, inputCurve):
        if inputCurve is None:
            ...
            strMessage = (
                "ERROR! XSDataInputAutoRg.setInputCurve argument is not list but %s"
                % inputCurve.__class__.__name__
            )
            raise BaseException(strMessage)

    def delInputCurve(self):
        self._inputCurve = None

    inputCurve = property(
        getInputCurve, setInputCurve, delInputCurve, "Property for inputCurve"
    )
    ...
    def addInputCurve(self, value):
        if value is None:
            ...
            strMessage = (
                "ERROR! XSDataInputAutoRg.addInputCurve argument is not XSDataFile but %s"
                % value.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def insertInputCurve(self, index, value):
        if index is None:
            strMessage = (
                "ERROR! XSDataInputAutoRg.insertInputCurve argument 'index' is None"
            )
            raise BaseException(strMessage)
        if value is None:
            strMessage = (
                "ERROR! XSDataInputAutoRg.insertInputCurve argument 'value' is None"
            )
            raise BaseException(strMessage)
        elif value.__class__.__name__ == "XSDataFile":
    ...
    def getMinIntervalLength(self):
        return self._minIntervalLength
    ...
    def setMinIntervalLength(self, minIntervalLength):
        if minIntervalLength is None:
            ...
            strMessage = (
                "ERROR! XSDataInputAutoRg.setMinIntervalLength argument is not XSDataInteger but %s"
                % minIntervalLength.__class__.__name__
            )
            raise BaseException(strMessage)

    def delMinIntervalLength(self):
        self._minIntervalLength = None

    minIntervalLength = property(
        getMinIntervalLength,
        setMinIntervalLength,
        delMinIntervalLength,
        "Property for minIntervalLength",
    )
    # Methods and properties for the 'maxSmaxRg' attribute
    def getMaxSmaxRg(self):
        return self._maxSmaxRg
    ...
    def setMaxSmaxRg(self, maxSmaxRg):
        if maxSmaxRg is None:
            ...
            strMessage = (
                "ERROR! XSDataInputAutoRg.setMaxSmaxRg argument is not XSDataDouble but %s"
                % maxSmaxRg.__class__.__name__
            )
            raise BaseException(strMessage)

    def delMaxSmaxRg(self):
        self._maxSmaxRg = None

    maxSmaxRg = property(
        getMaxSmaxRg, setMaxSmaxRg, delMaxSmaxRg, "Property for maxSmaxRg"
    )
    # Methods and properties for the 'maxSminRg' attribute
    def getMaxSminRg(self):
        return self._maxSminRg
    ...
    def setMaxSminRg(self, maxSminRg):
        if maxSminRg is None:
            ...
            strMessage = (
                "ERROR! XSDataInputAutoRg.setMaxSminRg argument is not XSDataDouble but %s"
                % maxSminRg.__class__.__name__
            )
            raise BaseException(strMessage)

    def delMaxSminRg(self):
        self._maxSminRg = None

    maxSminRg = property(
        getMaxSminRg, setMaxSminRg, delMaxSminRg, "Property for maxSminRg"
    )
    ...
    def buildChildren(self, child_, nodeName_):
        if child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "sample":
            ...
            obj_.build(child_)
            self.setSample(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "inputCurve":
            obj_ = XSDataFile()
            obj_.build(child_)
            self.inputCurve.append(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "minIntervalLength":
            obj_ = XSDataInteger()
            obj_.build(child_)
            self.setMinIntervalLength(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "maxSmaxRg":
            obj_ = XSDataDouble()
            obj_.build(child_)
            self.setMaxSmaxRg(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "maxSminRg":
            obj_ = XSDataDouble()
            obj_.build(child_)
    ...
    def outputFile(self, _outfileName):
        print(
            "WARNING: Method outputFile in class XSDataInputAutoRg is deprecated, please use instead exportToFile!"
        )
        self.exportToFile(_outfileName)
...
class XSDataInputAutoSub(XSDataInput):
    ...
    def __init__(
        self, configuration=None, subtractedCurve=None, sampleCurve=None, buffers=None
    ):
        XSDataInput.__init__(self, configuration)
        if buffers is None:
            self._buffers = []
            ...
            strMessage = (
                "ERROR! XSDataInputAutoSub constructor argument 'buffers' is not list but %s"
                % self._buffers.__class__.__name__
            )
            raise BaseException(strMessage)
        if sampleCurve is None:
            ...
            strMessage = (
                "ERROR! XSDataInputAutoSub constructor argument 'sampleCurve' is not XSDataFile but %s"
        ...
        if subtractedCurve is None:
            ...
            strMessage = (
                "ERROR! XSDataInputAutoSub constructor argument 'subtractedCurve' is not XSDataFile but %s"
    ...
    def setBuffers(self, buffers):
        if buffers is None:
            ...
            strMessage = (
                "ERROR! XSDataInputAutoSub.setBuffers argument is not list but %s"
                % buffers.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def addBuffers(self, value):
        if value is None:
            ...
            strMessage = (
                "ERROR! XSDataInputAutoSub.addBuffers argument is not XSDataFile but %s"
                % value.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def insertBuffers(self, index, value):
        if index is None:
            strMessage = (
                "ERROR! XSDataInputAutoSub.insertBuffers argument 'index' is None"
            )
            raise BaseException(strMessage)
        if value is None:
            strMessage = (
                "ERROR! XSDataInputAutoSub.insertBuffers argument 'value' is None"
            )
            raise BaseException(strMessage)
        elif value.__class__.__name__ == "XSDataFile":
    ...
    def setSampleCurve(self, sampleCurve):
        if sampleCurve is None:
            ...
            strMessage = (
                "ERROR! XSDataInputAutoSub.setSampleCurve argument is not XSDataFile but %s"
    ...
    def setSubtractedCurve(self, subtractedCurve):
        if subtractedCurve is None:
            ...
            strMessage = (
                "ERROR! XSDataInputAutoSub.setSubtractedCurve argument is not XSDataFile but %s"
    ...
    def buildChildren(self, child_, nodeName_):
        if child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "buffers":
            obj_ = XSDataFile()
            obj_.build(child_)
            self.buffers.append(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "sampleCurve":
            obj_ = XSDataFile()
            obj_.build(child_)
    ...
    def outputFile(self, _outfileName):
        print(
            "WARNING: Method outputFile in class XSDataInputAutoSub is deprecated, please use instead exportToFile!"
        )
        self.exportToFile(_outfileName)
...
class XSDataInputDamaver(XSDataInput):
    def __init__(
        self, configuration=None, automatic=None, symmetry=None, pdbInputFiles=None
    ):
        XSDataInput.__init__(self, configuration)
        if pdbInputFiles is None:
            ...
            strMessage = (
                "ERROR! XSDataInputDamaver constructor argument 'pdbInputFiles' is not list but %s"
                % self._pdbInputFiles.__class__.__name__
            )
            raise BaseException(strMessage)
        if symmetry is None:
            self._symmetry = None
            ...
            strMessage = (
                "ERROR! XSDataInputDamaver constructor argument 'symmetry' is not XSDataString but %s"
                % self._symmetry.__class__.__name__
            )
            raise BaseException(strMessage)
        if automatic is None:
            ...
            strMessage = (
                "ERROR! XSDataInputDamaver constructor argument 'automatic' is not XSDataBoolean but %s"
                % self._automatic.__class__.__name__
            )
            raise BaseException(strMessage)

    # Methods and properties for the 'pdbInputFiles' attribute
    def getPdbInputFiles(self):
        return self._pdbInputFiles
    ...
    def setPdbInputFiles(self, pdbInputFiles):
        if pdbInputFiles is None:
            ...
            strMessage = (
                "ERROR! XSDataInputDamaver.setPdbInputFiles argument is not list but %s"
                % pdbInputFiles.__class__.__name__
            )
            raise BaseException(strMessage)

    def delPdbInputFiles(self):
        self._pdbInputFiles = None

    pdbInputFiles = property(
        getPdbInputFiles,
        setPdbInputFiles,
        delPdbInputFiles,
        "Property for pdbInputFiles",
    )
    ...
    def addPdbInputFiles(self, value):
        if value is None:
            ...
            strMessage = (
                "ERROR! XSDataInputDamaver.addPdbInputFiles argument is not XSDataFile but %s"
                % value.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def insertPdbInputFiles(self, index, value):
        if index is None:
            strMessage = (
                "ERROR! XSDataInputDamaver.insertPdbInputFiles argument 'index' is None"
            )
            raise BaseException(strMessage)
        if value is None:
            strMessage = (
                "ERROR! XSDataInputDamaver.insertPdbInputFiles argument 'value' is None"
            )
            raise BaseException(strMessage)
        elif value.__class__.__name__ == "XSDataFile":
    ...
    def setSymmetry(self, symmetry):
        if symmetry is None:
            ...
            strMessage = (
                "ERROR! XSDataInputDamaver.setSymmetry argument is not XSDataString but %s"
                % symmetry.__class__.__name__
            )
            raise BaseException(strMessage)

    def delSymmetry(self):
        self._symmetry = None
    ...
    def setAutomatic(self, automatic):
        if automatic is None:
            ...
            strMessage = (
                "ERROR! XSDataInputDamaver.setAutomatic argument is not XSDataBoolean but %s"
                % automatic.__class__.__name__
            )
            raise BaseException(strMessage)

    def delAutomatic(self):
        self._automatic = None

    automatic = property(
        getAutomatic, setAutomatic, delAutomatic, "Property for automatic"
    )
    ...
    def buildChildren(self, child_, nodeName_):
        if child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "pdbInputFiles":
            obj_ = XSDataFile()
            obj_.build(child_)
            self.pdbInputFiles.append(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "symmetry":
            obj_ = XSDataString()
            obj_.build(child_)
            self.setSymmetry(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "automatic":
            obj_ = XSDataBoolean()
            obj_.build(child_)
    ...
    def outputFile(self, _outfileName):
        print(
            "WARNING: Method outputFile in class XSDataInputDamaver is deprecated, please use instead exportToFile!"
        )
        self.exportToFile(_outfileName)
...
class XSDataInputDamfilt(XSDataInput):
    def __init__(self, configuration=None, inputPdbFile=None):
        ...
        if inputPdbFile is None:
            ...
            strMessage = (
                "ERROR! XSDataInputDamfilt constructor argument 'inputPdbFile' is not XSDataFile but %s"
                % self._inputPdbFile.__class__.__name__
            )
            raise BaseException(strMessage)

    # Methods and properties for the 'inputPdbFile' attribute
    def getInputPdbFile(self):
        return self._inputPdbFile
    ...
    def setInputPdbFile(self, inputPdbFile):
        if inputPdbFile is None:
            ...
            strMessage = (
                "ERROR! XSDataInputDamfilt.setInputPdbFile argument is not XSDataFile but %s"
                % inputPdbFile.__class__.__name__
            )
            raise BaseException(strMessage)

    def delInputPdbFile(self):
        self._inputPdbFile = None

    inputPdbFile = property(
        getInputPdbFile, setInputPdbFile, delInputPdbFile, "Property for inputPdbFile"
    )
    ...
    def buildChildren(self, child_, nodeName_):
        if child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "inputPdbFile":
            obj_ = XSDataFile()
            obj_.build(child_)
    ...
    def outputFile(self, _outfileName):
        print(
            "WARNING: Method outputFile in class XSDataInputDamfilt is deprecated, please use instead exportToFile!"
        )
        self.exportToFile(_outfileName)
...
class XSDataInputDammif(XSDataInput):
    def __init__(
        ...
        if expectedParticleShape is None:
            ...
            strMessage = (
                "ERROR! XSDataInputDammif constructor argument 'expectedParticleShape' is not XSDataInteger but %s"
                % self._expectedParticleShape.__class__.__name__
            )
            raise BaseException(strMessage)
        if gnomOutputFile is None:
            ...
            strMessage = (
                "ERROR! XSDataInputDammif constructor argument 'gnomOutputFile' is not XSDataFile but %s"
                % self._gnomOutputFile.__class__.__name__
            )
            raise BaseException(strMessage)
        if unit is None:
            self._unit = None
            ...
            strMessage = (
                "ERROR! XSDataInputDammif constructor argument 'unit' is not XSDataString but %s"
                % self._unit.__class__.__name__
            )
            raise BaseException(strMessage)
        if symmetry is None:
            self._symmetry = None
            ...
            strMessage = (
                "ERROR! XSDataInputDammif constructor argument 'symmetry' is not XSDataString but %s"
                % self._symmetry.__class__.__name__
            )
            raise BaseException(strMessage)
        if mode is None:
            ...
            strMessage = (
                "ERROR! XSDataInputDammif constructor argument 'mode' is not XSDataString but %s"
                % self._mode.__class__.__name__
            )
            raise BaseException(strMessage)
        if chained is None:
            self._chained = None
            ...
            strMessage = (
                "ERROR! XSDataInputDammif constructor argument 'chained' is not XSDataBoolean but %s"
                % self._chained.__class__.__name__
            )
            raise BaseException(strMessage)
        if constant is None:
            self._constant = None
            ...
            strMessage = (
                "ERROR! XSDataInputDammif constructor argument 'constant' is not XSDataDouble but %s"
                % self._constant.__class__.__name__
            )
            raise BaseException(strMessage)
        if order is None:
            self._order = None
            ...
            strMessage = (
                "ERROR! XSDataInputDammif constructor argument 'order' is not XSDataInteger but %s"
                % self._order.__class__.__name__
            )
            raise BaseException(strMessage)

    # Methods and properties for the 'expectedParticleShape' attribute
    def getExpectedParticleShape(self):
        return self._expectedParticleShape
    ...
    def setExpectedParticleShape(self, expectedParticleShape):
        if expectedParticleShape is None:
            ...
            strMessage = (
                "ERROR! XSDataInputDammif.setExpectedParticleShape argument is not XSDataInteger but %s"
                % expectedParticleShape.__class__.__name__
            )
            raise BaseException(strMessage)

    def delExpectedParticleShape(self):
        self._expectedParticleShape = None

    expectedParticleShape = property(
        getExpectedParticleShape,
        setExpectedParticleShape,
        delExpectedParticleShape,
        "Property for expectedParticleShape",
    )
    # Methods and properties for the 'gnomOutputFile' attribute
    def getGnomOutputFile(self):
        return self._gnomOutputFile
    ...
    def setGnomOutputFile(self, gnomOutputFile):
        if gnomOutputFile is None:
            ...
            strMessage = (
                "ERROR! XSDataInputDammif.setGnomOutputFile argument is not XSDataFile but %s"
                % gnomOutputFile.__class__.__name__
            )
            raise BaseException(strMessage)

    def delGnomOutputFile(self):
        self._gnomOutputFile = None

    gnomOutputFile = property(
        getGnomOutputFile,
        setGnomOutputFile,
        delGnomOutputFile,
        "Property for gnomOutputFile",
    )
    ...
    def setUnit(self, unit):
        if unit is None:
            ...
            strMessage = (
                "ERROR! XSDataInputDammif.setUnit argument is not XSDataString but %s"
    ...
    def setSymmetry(self, symmetry):
        if symmetry is None:
            ...
            strMessage = (
                "ERROR! XSDataInputDammif.setSymmetry argument is not XSDataString but %s"
                % symmetry.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setMode(self, mode):
        if mode is None:
            ...
            strMessage = (
                "ERROR! XSDataInputDammif.setMode argument is not XSDataString but %s"
    ...
    def setChained(self, chained):
        if chained is None:
            ...
            strMessage = (
                "ERROR! XSDataInputDammif.setChained argument is not XSDataBoolean but %s"
                % chained.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setConstant(self, constant):
        if constant is None:
            ...
            strMessage = (
                "ERROR! XSDataInputDammif.setConstant argument is not XSDataDouble but %s"
    ...
    def setOrder(self, order):
        if order is None:
            ...
            strMessage = (
                "ERROR! XSDataInputDammif.setOrder argument is not XSDataInteger but %s"
    ...
    def exportChildren(self, outfile, level, name_="XSDataInputDammif"):
        ...
        if self._expectedParticleShape is not None:
            self.expectedParticleShape.export(
                outfile, level, name_="expectedParticleShape"
            )
        else:
    ...
    def buildChildren(self, child_, nodeName_):
        if (
            ...
            and nodeName_ == "expectedParticleShape"
        ):
            obj_ = XSDataInteger()
            obj_.build(child_)
            self.setExpectedParticleShape(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "gnomOutputFile":
            obj_ = XSDataFile()
            obj_.build(child_)
            ...
            obj_.build(child_)
            self.setSymmetry(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "mode":
            obj_ = XSDataString()
            obj_.build(child_)
            self.setMode(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "chained":
            obj_ = XSDataBoolean()
            obj_.build(child_)
            self.setChained(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "constant":
            obj_ = XSDataDouble()
            obj_.build(child_)
            self.setConstant(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "order":
            obj_ = XSDataInteger()
            obj_.build(child_)
            self.setOrder(obj_)
        XSDataInput.buildChildren(self, child_, nodeName_)
    ...
    def outputFile(self, _outfileName):
        print(
            "WARNING: Method outputFile in class XSDataInputDammif is deprecated, please use instead exportToFile!"
        )
        self.exportToFile(_outfileName)
...
class XSDataInputDammin(XSDataInput):
    ...
    def __init__(
        ...
        if expectedParticleShape is None:
            ...
            strMessage = (
                "ERROR! XSDataInputDammin constructor argument 'expectedParticleShape' is not XSDataInteger but %s"
                % self._expectedParticleShape.__class__.__name__
            )
            raise BaseException(strMessage)
        if gnomOutputFile is None:
            ...
            strMessage = (
                "ERROR! XSDataInputDammin constructor argument 'gnomOutputFile' is not XSDataFile but %s"
                % self._gnomOutputFile.__class__.__name__
            )
            raise BaseException(strMessage)
        if initialDummyAtomModel is None:
            ...
            strMessage = (
                "ERROR! XSDataInputDammin constructor argument 'initialDummyAtomModel' is not XSDataInteger but %s"
                % self._initialDummyAtomModel.__class__.__name__
            )
            raise BaseException(strMessage)
        if pdbInputFile is None:
            ...
            strMessage = (
                "ERROR! XSDataInputDammin constructor argument 'pdbInputFile' is not XSDataFile but %s"
                % self._pdbInputFile.__class__.__name__
            )
            raise BaseException(strMessage)
        if symmetry is None:
            self._symmetry = None
            ...
            strMessage = (
                "ERROR! XSDataInputDammin constructor argument 'symmetry' is not XSDataString but %s"
                % self._symmetry.__class__.__name__
            )
            raise BaseException(strMessage)
        if mode is None:
            ...
            strMessage = (
                "ERROR! XSDataInputDammin constructor argument 'mode' is not XSDataString but %s"
                % self._mode.__class__.__name__
            )
            raise BaseException(strMessage)
        if unit is None:
            ...
            strMessage = (
                "ERROR! XSDataInputDammin constructor argument 'unit' is not XSDataString but %s"
                % self._unit.__class__.__name__
            )
            raise BaseException(strMessage)
        if name is None:
            ...
            strMessage = (
                "ERROR! XSDataInputDammin constructor argument 'name' is not XSDataString but %s"
                % self._name.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setExpectedParticleShape(self, expectedParticleShape):
        if expectedParticleShape is None:
            ...
            strMessage = (
                "ERROR! XSDataInputDammin.setExpectedParticleShape argument is not XSDataInteger but %s"
                % expectedParticleShape.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setGnomOutputFile(self, gnomOutputFile):
        if gnomOutputFile is None:
            ...
            strMessage = (
                "ERROR! XSDataInputDammin.setGnomOutputFile argument is not XSDataFile but %s"
                % gnomOutputFile.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def getInitialDummyAtomModel(self):
        return self._initialDummyAtomModel
    ...
    def setInitialDummyAtomModel(self, initialDummyAtomModel):
        if initialDummyAtomModel is None:
            ...
            strMessage = (
                "ERROR! XSDataInputDammin.setInitialDummyAtomModel argument is not XSDataInteger but %s"
                % initialDummyAtomModel.__class__.__name__
            )
            raise BaseException(strMessage)

    def delInitialDummyAtomModel(self):
        self._initialDummyAtomModel = None

    initialDummyAtomModel = property(
        getInitialDummyAtomModel,
        setInitialDummyAtomModel,
        delInitialDummyAtomModel,
        "Property for initialDummyAtomModel",
    )
    # Methods and properties for the 'pdbInputFile' attribute
    def getPdbInputFile(self):
        return self._pdbInputFile
    ...
    def setPdbInputFile(self, pdbInputFile):
        if pdbInputFile is None:
            ...
            strMessage = (
                "ERROR! XSDataInputDammin.setPdbInputFile argument is not XSDataFile but %s"
                % pdbInputFile.__class__.__name__
            )
            raise BaseException(strMessage)

    def delPdbInputFile(self):
        self._pdbInputFile = None

    pdbInputFile = property(
        getPdbInputFile, setPdbInputFile, delPdbInputFile, "Property for pdbInputFile"
    )
    # Methods and properties for the 'symmetry' attribute
    def getSymmetry(self):
        return self._symmetry
    ...
    def setSymmetry(self, symmetry):
        if symmetry is None:
            ...
            strMessage = (
                "ERROR! XSDataInputDammin.setSymmetry argument is not XSDataString but %s"
                % symmetry.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setMode(self, mode):
        if mode is None:
            ...
            strMessage = (
                "ERROR! XSDataInputDammin.setMode argument is not XSDataString but %s"
                % mode.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setUnit(self, unit):
        if unit is None:
            ...
            strMessage = (
                "ERROR! XSDataInputDammin.setUnit argument is not XSDataString but %s"
                % unit.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setName(self, name):
        if name is None:
            ...
            strMessage = (
                "ERROR! XSDataInputDammin.setName argument is not XSDataString but %s"
                % name.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def exportChildren(self, outfile, level, name_="XSDataInputDammin"):
        ...
        if self._initialDummyAtomModel is not None:
            self.initialDummyAtomModel.export(
                outfile, level, name_="initialDummyAtomModel"
            )
        else:
    ...
    def buildChildren(self, child_, nodeName_):
        if (
            ...
            child_.nodeType == Node.ELEMENT_NODE
            and nodeName_ == "initialDummyAtomModel"
        ):
            obj_ = XSDataInteger()
            obj_.build(child_)
            self.setInitialDummyAtomModel(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "pdbInputFile":
            obj_ = XSDataFile()
            obj_.build(child_)
    ...
    def outputFile(self, _outfileName):
        print(
            "WARNING: Method outputFile in class XSDataInputDammin is deprecated, please use instead exportToFile!"
        )
        self.exportToFile(_outfileName)
...
class XSDataInputDamstart(XSDataInput):
    def __init__(self, configuration=None, inputPdbFile=None):
        ...
        if inputPdbFile is None:
            ...
            strMessage = (
                "ERROR! XSDataInputDamstart constructor argument 'inputPdbFile' is not XSDataFile but %s"
                % self._inputPdbFile.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setInputPdbFile(self, inputPdbFile):
        if inputPdbFile is None:
            ...
            strMessage = (
                "ERROR! XSDataInputDamstart.setInputPdbFile argument is not XSDataFile but %s"
                % inputPdbFile.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def outputFile(self, _outfileName):
        print(
            "WARNING: Method outputFile in class XSDataInputDamstart is deprecated, please use instead exportToFile!"
        )
        self.exportToFile(_outfileName)
...
class XSDataInputDatGnom(XSDataInput):
    ...
    def __init__(
        self, configuration=None, output=None, skip=None, rg=None, inputCurve=None
    ):
        XSDataInput.__init__(self, configuration)
        if inputCurve is None:
            self._inputCurve = None
            ...
            strMessage = (
                "ERROR! XSDataInputDatGnom constructor argument 'inputCurve' is not XSDataFile but %s"
                % self._inputCurve.__class__.__name__
            )
            raise BaseException(strMessage)
        if rg is None:
            ...
            strMessage = (
                "ERROR! XSDataInputDatGnom constructor argument 'rg' is not XSDataLength but %s"
                % self._rg.__class__.__name__
            )
            raise BaseException(strMessage)
        if skip is None:
            ...
            strMessage = (
                "ERROR! XSDataInputDatGnom constructor argument 'skip' is not XSDataInteger but %s"
                % self._skip.__class__.__name__
            )
            raise BaseException(strMessage)
        if output is None:
            self._output = None
            ...
            strMessage = (
                "ERROR! XSDataInputDatGnom constructor argument 'output' is not XSDataFile but %s"
                % self._output.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setInputCurve(self, inputCurve):
        if inputCurve is None:
            ...
            strMessage = (
                "ERROR! XSDataInputDatGnom.setInputCurve argument is not XSDataFile but %s"
                % inputCurve.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setRg(self, rg):
        if rg is None:
            ...
            strMessage = (
                "ERROR! XSDataInputDatGnom.setRg argument is not XSDataLength but %s"
                % rg.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setSkip(self, skip):
        if skip is None:
            ...
            strMessage = (
                "ERROR! XSDataInputDatGnom.setSkip argument is not XSDataInteger but %s"
                % skip.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setOutput(self, output):
        if output is None:
            ...
            strMessage = (
                "ERROR! XSDataInputDatGnom.setOutput argument is not XSDataFile but %s"
                % output.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def buildChildren(self, child_, nodeName_):
        if child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "inputCurve":
            obj_ = XSDataFile()
            obj_.build(child_)
            ...
            obj_.build(child_)
            self.setRg(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "skip":
            obj_ = XSDataInteger()
            obj_.build(child_)
            self.setSkip(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "output":
    ...
    def outputFile(self, _outfileName):
        print(
            "WARNING: Method outputFile in class XSDataInputDatGnom is deprecated, please use instead exportToFile!"
        )
        self.exportToFile(_outfileName)
...
class XSDataInputDatPorod(XSDataInput):
    ...
    def __init__(self, configuration=None, gnomFile=None):
        ...
        if gnomFile is None:
            ...
            strMessage = (
                "ERROR! XSDataInputDatPorod constructor argument 'gnomFile' is not XSDataFile but %s"
                % self._gnomFile.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setGnomFile(self, gnomFile):
        if gnomFile is None:
            ...
            strMessage = (
                "ERROR! XSDataInputDatPorod.setGnomFile argument is not XSDataFile but %s"
                % gnomFile.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def outputFile(self, _outfileName):
        print(
            "WARNING: Method outputFile in class XSDataInputDatPorod is deprecated, please use instead exportToFile!"
        )
        self.exportToFile(_outfileName)
...
class XSDataInputDataver(XSDataInput):
    ...
    def __init__(self, configuration=None, outputCurve=None, inputCurve=None):
        ...
        if inputCurve is None:
            ...
            strMessage = (
                "ERROR! XSDataInputDataver constructor argument 'inputCurve' is not list but %s"
                % self._inputCurve.__class__.__name__
            )
            raise BaseException(strMessage)
        if outputCurve is None:
            ...
            strMessage = (
                "ERROR! XSDataInputDataver constructor argument 'outputCurve' is not XSDataFile but %s"
    ...
    def setInputCurve(self, inputCurve):
        if inputCurve is None:
            ...
            strMessage = (
                "ERROR! XSDataInputDataver.setInputCurve argument is not list but %s"
                % inputCurve.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def addInputCurve(self, value):
        if value is None:
            ...
            strMessage = (
                "ERROR! XSDataInputDataver.addInputCurve argument is not XSDataFile but %s"
                % value.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def insertInputCurve(self, index, value):
        if index is None:
            strMessage = (
                "ERROR! XSDataInputDataver.insertInputCurve argument 'index' is None"
            )
            raise BaseException(strMessage)
        if value is None:
            strMessage = (
                "ERROR! XSDataInputDataver.insertInputCurve argument 'value' is None"
            )
            raise BaseException(strMessage)
        elif value.__class__.__name__ == "XSDataFile":
            self._inputCurve[index] = value
    ...
    def setOutputCurve(self, outputCurve):
        if outputCurve is None:
            ...
            strMessage = (
                "ERROR! XSDataInputDataver.setOutputCurve argument is not XSDataFile but %s"
    ...
    def buildChildren(self, child_, nodeName_):
        if child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "inputCurve":
            ...
            obj_.build(child_)
            self.inputCurve.append(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "outputCurve":
            obj_ = XSDataFile()
            obj_.build(child_)
    ...
    def outputFile(self, _outfileName):
        print(
            "WARNING: Method outputFile in class XSDataInputDataver is deprecated, please use instead exportToFile!"
        )
        self.exportToFile(_outfileName)
...
class XSDataInputDatcmp(XSDataInput):
    ...
    def __init__(self, configuration=None, inputCurve=None):
        ...
        if inputCurve is None:
            ...
            strMessage = (
                "ERROR! XSDataInputDatcmp constructor argument 'inputCurve' is not list but %s"
                % self._inputCurve.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setInputCurve(self, inputCurve):
        if inputCurve is None:
            ...
            strMessage = (
                "ERROR! XSDataInputDatcmp.setInputCurve argument is not list but %s"
                % inputCurve.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def addInputCurve(self, value):
        if value is None:
            ...
            strMessage = (
                "ERROR! XSDataInputDatcmp.addInputCurve argument is not XSDataFile but %s"
                % value.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def insertInputCurve(self, index, value):
        if index is None:
            strMessage = (
                "ERROR! XSDataInputDatcmp.insertInputCurve argument 'index' is None"
            )
            raise BaseException(strMessage)
        if value is None:
            strMessage = (
                "ERROR! XSDataInputDatcmp.insertInputCurve argument 'value' is None"
            )
            raise BaseException(strMessage)
        elif value.__class__.__name__ == "XSDataFile":
            self._inputCurve[index] = value
    ...
    def outputFile(self, _outfileName):
        print(
            "WARNING: Method outputFile in class XSDataInputDatcmp is deprecated, please use instead exportToFile!"
        )
        self.exportToFile(_outfileName)
...
class XSDataInputDatop(XSDataInput):
    ...
    def __init__(
        ...
        if inputCurve is None:
            ...
            strMessage = (
                "ERROR! XSDataInputDatop constructor argument 'inputCurve' is not list but %s"
                % self._inputCurve.__class__.__name__
            )
            raise BaseException(strMessage)
        if outputCurve is None:
            ...
            strMessage = (
                "ERROR! XSDataInputDatop constructor argument 'outputCurve' is not XSDataFile but %s"
                % self._outputCurve.__class__.__name__
            )
            raise BaseException(strMessage)
        if operation is None:
            ...
            strMessage = (
                "ERROR! XSDataInputDatop constructor argument 'operation' is not XSDataString but %s"
                % self._operation.__class__.__name__
            )
            raise BaseException(strMessage)
        if constant is None:
            self._constant = None
            ...
            strMessage = (
                "ERROR! XSDataInputDatop constructor argument 'constant' is not XSDataDouble but %s"
                % self._constant.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setInputCurve(self, inputCurve):
        if inputCurve is None:
            ...
            strMessage = (
                "ERROR! XSDataInputDatop.setInputCurve argument is not list but %s"
                % inputCurve.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def addInputCurve(self, value):
        if value is None:
            ...
            strMessage = (
                "ERROR! XSDataInputDatop.addInputCurve argument is not XSDataFile but %s"
                % value.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def insertInputCurve(self, index, value):
        if index is None:
            strMessage = (
                "ERROR! XSDataInputDatop.insertInputCurve argument 'index' is None"
            )
            raise BaseException(strMessage)
        if value is None:
            strMessage = (
                "ERROR! XSDataInputDatop.insertInputCurve argument 'value' is None"
            )
            raise BaseException(strMessage)
        elif value.__class__.__name__ == "XSDataFile":
            self._inputCurve[index] = value
    ...
    def setOutputCurve(self, outputCurve):
        if outputCurve is None:
            ...
            strMessage = (
                "ERROR! XSDataInputDatop.setOutputCurve argument is not XSDataFile but %s"
                % outputCurve.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setOperation(self, operation):
        if operation is None:
            ...
            strMessage = (
                "ERROR! XSDataInputDatop.setOperation argument is not XSDataString but %s"
    ...
    operation = property(
        getOperation, setOperation, delOperation, "Property for operation"
    )
    # Methods and properties for the 'constant' attribute
    def getConstant(self):
        return self._constant
    ...
    def setConstant(self, constant):
        if constant is None:
            ...
            strMessage = (
                "ERROR! XSDataInputDatop.setConstant argument is not XSDataDouble but %s"
                % constant.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def buildChildren(self, child_, nodeName_):
        if child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "inputCurve":
            ...
            obj_.build(child_)
            self.setOutputCurve(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "operation":
            obj_ = XSDataString()
            obj_.build(child_)
    ...
    def outputFile(self, _outfileName):
        print(
            "WARNING: Method outputFile in class XSDataInputDatop is deprecated, please use instead exportToFile!"
        )
        self.exportToFile(_outfileName)
...
class XSDataInputGnom(XSDataInput):
    ...
    def __init__(
        ...
        mode=None,
        angularScale=None,
        experimentalDataFile=None,
        experimentalDataStdArray=None,
        experimentalDataStdDev=None,
        experimentalDataIArray=None,
        experimentalDataValues=None,
        experimentalDataQArray=None,
        experimentalDataQ=None,
        rMax=None,
    ):
        XSDataInput.__init__(self, configuration)
        if rMax is None:
            ...
            strMessage = (
                "ERROR! XSDataInputGnom constructor argument 'rMax' is not XSDataDouble but %s"
                % self._rMax.__class__.__name__
            )
            raise BaseException(strMessage)
        if experimentalDataQ is None:
            ...
            strMessage = (
                "ERROR! XSDataInputGnom constructor argument 'experimentalDataQ' is not list but %s"
                % self._experimentalDataQ.__class__.__name__
            )
            raise BaseException(strMessage)
        if experimentalDataQArray is None:
            ...
            strMessage = (
                "ERROR! XSDataInputGnom constructor argument 'experimentalDataQArray' is not XSDataArray but %s"
                % self._experimentalDataQArray.__class__.__name__
            )
            raise BaseException(strMessage)
        if experimentalDataValues is None:
            ...
            strMessage = (
                "ERROR! XSDataInputGnom constructor argument 'experimentalDataValues' is not list but %s"
                % self._experimentalDataValues.__class__.__name__
            )
            raise BaseException(strMessage)
        if experimentalDataIArray is None:
            ...
            strMessage = (
                "ERROR! XSDataInputGnom constructor argument 'experimentalDataIArray' is not XSDataArray but %s"
                % self._experimentalDataIArray.__class__.__name__
            )
            raise BaseException(strMessage)
        if experimentalDataStdDev is None:
            ...
            strMessage = (
                "ERROR! XSDataInputGnom constructor argument 'experimentalDataStdDev' is not list but %s"
                % self._experimentalDataStdDev.__class__.__name__
            )
            raise BaseException(strMessage)
        if experimentalDataStdArray is None:
            ...
            strMessage = (
                "ERROR! XSDataInputGnom constructor argument 'experimentalDataStdArray' is not XSDataArray but %s"
                % self._experimentalDataStdArray.__class__.__name__
            )
            raise BaseException(strMessage)
        if experimentalDataFile is None:
            ...
            strMessage = (
                "ERROR! XSDataInputGnom constructor argument 'experimentalDataFile' is not XSDataFile but %s"
                % self._experimentalDataFile.__class__.__name__
            )
            raise BaseException(strMessage)
        if angularScale is None:
            ...
            strMessage = (
                "ERROR! XSDataInputGnom constructor argument 'angularScale' is not XSDataInteger but %s"
                % self._angularScale.__class__.__name__
            )
            raise BaseException(strMessage)
        if mode is None:
            self._mode = None
            ...
            strMessage = (
                "ERROR! XSDataInputGnom constructor argument 'mode' is not XSDataString but %s"
                % self._mode.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setRMax(self, rMax):
        if rMax is None:
            ...
            strMessage = (
                "ERROR! XSDataInputGnom.setRMax argument is not XSDataDouble but %s"
                % rMax.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def getExperimentalDataQ(self):
        return self._experimentalDataQ
    ...
    def setExperimentalDataQ(self, experimentalDataQ):
        if experimentalDataQ is None:
            ...
            strMessage = (
                "ERROR! XSDataInputGnom.setExperimentalDataQ argument is not list but %s"
                % experimentalDataQ.__class__.__name__
            )
            raise BaseException(strMessage)

    def delExperimentalDataQ(self):
        self._experimentalDataQ = None

    experimentalDataQ = property(
        getExperimentalDataQ,
        setExperimentalDataQ,
        delExperimentalDataQ,
        "Property for experimentalDataQ",
    )
    ...
    def addExperimentalDataQ(self, value):
        if value is None:
            ...
            strMessage = (
                "ERROR! XSDataInputGnom.addExperimentalDataQ argument is not XSDataDouble but %s"
                % value.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def getExperimentalDataQArray(self):
        return self._experimentalDataQArray
    ...
    def setExperimentalDataQArray(self, experimentalDataQArray):
        if experimentalDataQArray is None:
            ...
            strMessage = (
                "ERROR! XSDataInputGnom.setExperimentalDataQArray argument is not XSDataArray but %s"
                % experimentalDataQArray.__class__.__name__
            )
            raise BaseException(strMessage)

    def delExperimentalDataQArray(self):
        self._experimentalDataQArray = None

    experimentalDataQArray = property(
        getExperimentalDataQArray,
        setExperimentalDataQArray,
        delExperimentalDataQArray,
        "Property for experimentalDataQArray",
    )
    # Methods and properties for the 'experimentalDataValues' attribute
    def getExperimentalDataValues(self):
        return self._experimentalDataValues
    ...
    def setExperimentalDataValues(self, experimentalDataValues):
        if experimentalDataValues is None:
            ...
            strMessage = (
                "ERROR! XSDataInputGnom.setExperimentalDataValues argument is not list but %s"
                % experimentalDataValues.__class__.__name__
            )
            raise BaseException(strMessage)

    def delExperimentalDataValues(self):
        self._experimentalDataValues = None

    experimentalDataValues = property(
        getExperimentalDataValues,
        setExperimentalDataValues,
        delExperimentalDataValues,
        "Property for experimentalDataValues",
    )

    def addExperimentalDataValues(self, value):
        if value is None:
            strMessage = (
                "ERROR! XSDataInputGnom.addExperimentalDataValues argument is None"
            )
            raise BaseException(strMessage)
        elif value.__class__.__name__ == "XSDataDouble":
            ...
            strMessage = (
                "ERROR! XSDataInputGnom.addExperimentalDataValues argument is not XSDataDouble but %s"
                % value.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def getExperimentalDataIArray(self):
        return self._experimentalDataIArray
    ...
    def setExperimentalDataIArray(self, experimentalDataIArray):
        if experimentalDataIArray is None:
            ...
            strMessage = (
                "ERROR! XSDataInputGnom.setExperimentalDataIArray argument is not XSDataArray but %s"
                % experimentalDataIArray.__class__.__name__
            )
            raise BaseException(strMessage)

    def delExperimentalDataIArray(self):
        self._experimentalDataIArray = None

    experimentalDataIArray = property(
        getExperimentalDataIArray,
        setExperimentalDataIArray,
        delExperimentalDataIArray,
        "Property for experimentalDataIArray",
    )
    # Methods and properties for the 'experimentalDataStdDev' attribute
    def getExperimentalDataStdDev(self):
        return self._experimentalDataStdDev
    ...
    def setExperimentalDataStdDev(self, experimentalDataStdDev):
        if experimentalDataStdDev is None:
            ...
            strMessage = (
                "ERROR! XSDataInputGnom.setExperimentalDataStdDev argument is not list but %s"
                % experimentalDataStdDev.__class__.__name__
            )
            raise BaseException(strMessage)

    def delExperimentalDataStdDev(self):
        self._experimentalDataStdDev = None

    experimentalDataStdDev = property(
        getExperimentalDataStdDev,
        setExperimentalDataStdDev,
        delExperimentalDataStdDev,
        "Property for experimentalDataStdDev",
    )

    def addExperimentalDataStdDev(self, value):
        if value is None:
            strMessage = (
                "ERROR! XSDataInputGnom.addExperimentalDataStdDev argument is None"
            )
            raise BaseException(strMessage)
        elif value.__class__.__name__ == "XSDataDouble":
            ...
            strMessage = (
                "ERROR! XSDataInputGnom.addExperimentalDataStdDev argument is not XSDataDouble but %s"
                % value.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def getExperimentalDataStdArray(self):
        return self._experimentalDataStdArray
    ...
    def setExperimentalDataStdArray(self, experimentalDataStdArray):
        if experimentalDataStdArray is None:
            ...
            strMessage = (
                "ERROR! XSDataInputGnom.setExperimentalDataStdArray argument is not XSDataArray but %s"
                % experimentalDataStdArray.__class__.__name__
            )
            raise BaseException(strMessage)

    def delExperimentalDataStdArray(self):
        self._experimentalDataStdArray = None

    experimentalDataStdArray = property(
        getExperimentalDataStdArray,
        setExperimentalDataStdArray,
        delExperimentalDataStdArray,
        "Property for experimentalDataStdArray",
    )
    # Methods and properties for the 'experimentalDataFile' attribute
    def getExperimentalDataFile(self):
        return self._experimentalDataFile
    ...
    def setExperimentalDataFile(self, experimentalDataFile):
        if experimentalDataFile is None:
            ...
            strMessage = (
                "ERROR! XSDataInputGnom.setExperimentalDataFile argument is not XSDataFile but %s"
                % experimentalDataFile.__class__.__name__
            )
            raise BaseException(strMessage)

    def delExperimentalDataFile(self):
        self._experimentalDataFile = None

    experimentalDataFile = property(
        getExperimentalDataFile,
        setExperimentalDataFile,
        delExperimentalDataFile,
        "Property for experimentalDataFile",
    )
    # Methods and properties for the 'angularScale' attribute
    def getAngularScale(self):
        return self._angularScale
    ...
    def setAngularScale(self, angularScale):
        if angularScale is None:
            ...
            strMessage = (
                "ERROR! XSDataInputGnom.setAngularScale argument is not XSDataInteger but %s"
                % angularScale.__class__.__name__
            )
            raise BaseException(strMessage)

    def delAngularScale(self):
        self._angularScale = None

    angularScale = property(
        getAngularScale, setAngularScale, delAngularScale, "Property for angularScale"
    )
    # Methods and properties for the 'mode' attribute
    def getMode(self):
        return self._mode
    ...
    def setMode(self, mode):
        if mode is None:
            ...
            strMessage = (
                "ERROR! XSDataInputGnom.setMode argument is not XSDataString but %s"
                % mode.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def exportChildren(self, outfile, level, name_="XSDataInputGnom"):
        ...
        if self._experimentalDataQArray is not None:
            self.experimentalDataQArray.export(
                outfile, level, name_="experimentalDataQArray"
            )
        for experimentalDataValues_ in self.getExperimentalDataValues():
            experimentalDataValues_.export(
                outfile, level, name_="experimentalDataValues"
            )
        if self._experimentalDataIArray is not None:
            self.experimentalDataIArray.export(
                outfile, level, name_="experimentalDataIArray"
            )
        for experimentalDataStdDev_ in self.getExperimentalDataStdDev():
            experimentalDataStdDev_.export(
                outfile, level, name_="experimentalDataStdDev"
            )
        if self._experimentalDataStdArray is not None:
            self.experimentalDataStdArray.export(
                outfile, level, name_="experimentalDataStdArray"
            )
        if self._experimentalDataFile is not None:
            self.experimentalDataFile.export(
                outfile, level, name_="experimentalDataFile"
            )
    ...
    def buildChildren(self, child_, nodeName_):
        if child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "rMax":
            obj_ = XSDataDouble()
            obj_.build(child_)
            self.setRMax(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "experimentalDataQ":
            obj_ = XSDataDouble()
            obj_.build(child_)
            self.experimentalDataQ.append(obj_)
        elif (
            child_.nodeType == Node.ELEMENT_NODE
            and nodeName_ == "experimentalDataQArray"
        ):
            obj_ = XSDataArray()
            obj_.build(child_)
            ...
            child_.nodeType == Node.ELEMENT_NODE
            and nodeName_ == "experimentalDataValues"
        ):
            obj_ = XSDataDouble()
            obj_.build(child_)
            ...
            child_.nodeType == Node.ELEMENT_NODE
            and nodeName_ == "experimentalDataIArray"
        ):
            obj_ = XSDataArray()
            obj_.build(child_)
            ...
            child_.nodeType == Node.ELEMENT_NODE
            and nodeName_ == "experimentalDataStdDev"
        ):
            obj_ = XSDataDouble()
            obj_.build(child_)
            ...
            child_.nodeType == Node.ELEMENT_NODE
            and nodeName_ == "experimentalDataStdArray"
        ):
            obj_ = XSDataArray()
            obj_.build(child_)
            self.setExperimentalDataStdArray(obj_)
        elif (
            child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "experimentalDataFile"
        ):
            obj_ = XSDataFile()
            obj_.build(child_)
            self.setExperimentalDataFile(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "angularScale":
            obj_ = XSDataInteger()
            obj_.build(child_)
    ...
    def outputFile(self, _outfileName):
        print(
            "WARNING: Method outputFile in class XSDataInputGnom is deprecated, please use instead exportToFile!"
        )
        self.exportToFile(_outfileName)
...
class XSDataInputSaxsAnalysis(XSDataInput):
    ...
    def __init__(
        ...
        if scatterCurve is None:
            ...
            strMessage = (
                "ERROR! XSDataInputSaxsAnalysis constructor argument 'scatterCurve' is not XSDataFile but %s"
                % self._scatterCurve.__class__.__name__
            )
            raise BaseException(strMessage)
        if autoRg is None:
            self._autoRg = None
            ...
            strMessage = (
                "ERROR! XSDataInputSaxsAnalysis constructor argument 'autoRg' is not XSDataAutoRg but %s"
        ...
        if gnomFile is None:
            ...
            strMessage = (
                "ERROR! XSDataInputSaxsAnalysis constructor argument 'gnomFile' is not XSDataFile but %s"
                % self._gnomFile.__class__.__name__
            )
            raise BaseException(strMessage)
        if graphFormat is None:
            ...
            strMessage = (
                "ERROR! XSDataInputSaxsAnalysis constructor argument 'graphFormat' is not XSDataString but %s"
                % self._graphFormat.__class__.__name__
            )
            raise BaseException(strMessage)

    # Methods and properties for the 'scatterCurve' attribute
    def getScatterCurve(self):
        return self._scatterCurve
    ...
    def setScatterCurve(self, scatterCurve):
        if scatterCurve is None:
            ...
            strMessage = (
                "ERROR! XSDataInputSaxsAnalysis.setScatterCurve argument is not XSDataFile but %s"
                % scatterCurve.__class__.__name__
            )
            raise BaseException(strMessage)

    def delScatterCurve(self):
        self._scatterCurve = None

    scatterCurve = property(
        getScatterCurve, setScatterCurve, delScatterCurve, "Property for scatterCurve"
    )
    ...
    def setAutoRg(self, autoRg):
        if autoRg is None:
            ...
            strMessage = (
                "ERROR! XSDataInputSaxsAnalysis.setAutoRg argument is not XSDataAutoRg but %s"
    ...
    def setGnomFile(self, gnomFile):
        if gnomFile is None:
            ...
            strMessage = (
                "ERROR! XSDataInputSaxsAnalysis.setGnomFile argument is not XSDataFile but %s"
                % gnomFile.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def getGraphFormat(self):
        return self._graphFormat
    ...
    def setGraphFormat(self, graphFormat):
        if graphFormat is None:
            ...
            strMessage = (
                "ERROR! XSDataInputSaxsAnalysis.setGraphFormat argument is not XSDataString but %s"
                % graphFormat.__class__.__name__
            )
            raise BaseException(strMessage)

    def delGraphFormat(self):
        self._graphFormat = None

    graphFormat = property(
        getGraphFormat, setGraphFormat, delGraphFormat, "Property for graphFormat"
    )
    ...
    def buildChildren(self, child_, nodeName_):
        if child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "scatterCurve":
            obj_ = XSDataFile()
            obj_.build(child_)
            ...
            obj_.build(child_)
            self.setGnomFile(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "graphFormat":
            obj_ = XSDataString()
            obj_.build(child_)
    ...
    def outputFile(self, _outfileName):
        print(
            "WARNING: Method outputFile in class XSDataInputSaxsAnalysis is deprecated, please use instead exportToFile!"
        )
        self.exportToFile(_outfileName)
...
class XSDataInputSaxsAnalysisModeling(XSDataInput):
    ...
    def __init__(
        ...
        if scatterCurve is None:
            ...
            strMessage = (
                "ERROR! XSDataInputSaxsAnalysisModeling constructor argument 'scatterCurve' is not XSDataFile but %s"
                % self._scatterCurve.__class__.__name__
            )
            raise BaseException(strMessage)
        if autoRg is None:
            ...
            strMessage = (
                "ERROR! XSDataInputSaxsAnalysisModeling constructor argument 'autoRg' is not XSDataAutoRg but %s"
                % self._autoRg.__class__.__name__
            )
            raise BaseException(strMessage)
        if gnomFile is None:
            ...
            strMessage = (
                "ERROR! XSDataInputSaxsAnalysisModeling constructor argument 'gnomFile' is not XSDataFile but %s"
                % self._gnomFile.__class__.__name__
            )
            raise BaseException(strMessage)
        if graphFormat is None:
            ...
            strMessage = (
                "ERROR! XSDataInputSaxsAnalysisModeling constructor argument 'graphFormat' is not XSDataString but %s"
                % self._graphFormat.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setScatterCurve(self, scatterCurve):
        if scatterCurve is None:
            ...
            strMessage = (
                "ERROR! XSDataInputSaxsAnalysisModeling.setScatterCurve argument is not XSDataFile but %s"
                % scatterCurve.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setAutoRg(self, autoRg):
        if autoRg is None:
            ...
            strMessage = (
                "ERROR! XSDataInputSaxsAnalysisModeling.setAutoRg argument is not XSDataAutoRg but %s"
                % autoRg.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setGnomFile(self, gnomFile):
        if gnomFile is None:
            ...
            strMessage = (
                "ERROR! XSDataInputSaxsAnalysisModeling.setGnomFile argument is not XSDataFile but %s"
                % gnomFile.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setGraphFormat(self, graphFormat):
        if graphFormat is None:
            ...
            strMessage = (
                "ERROR! XSDataInputSaxsAnalysisModeling.setGraphFormat argument is not XSDataString but %s"
                % graphFormat.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def outputFile(self, _outfileName):
        print(
            "WARNING: Method outputFile in class XSDataInputSaxsAnalysisModeling is deprecated, please use instead exportToFile!"
        )
        self.exportToFile(_outfileName)
...
class XSDataInputSaxsModeling(XSDataInput):
    ...
    def __init__(self, configuration=None, graphFormat=None, gnomFile=None):
        ...
        if gnomFile is None:
            ...
            strMessage = (
                "ERROR! XSDataInputSaxsModeling constructor argument 'gnomFile' is not XSDataFile but %s"
                % self._gnomFile.__class__.__name__
            )
            raise BaseException(strMessage)
        if graphFormat is None:
            ...
            strMessage = (
                "ERROR! XSDataInputSaxsModeling constructor argument 'graphFormat' is not XSDataString but %s"
                % self._graphFormat.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setGnomFile(self, gnomFile):
        if gnomFile is None:
            ...
            strMessage = (
                "ERROR! XSDataInputSaxsModeling.setGnomFile argument is not XSDataFile but %s"
                % gnomFile.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setGraphFormat(self, graphFormat):
        if graphFormat is None:
            ...
            strMessage = (
                "ERROR! XSDataInputSaxsModeling.setGraphFormat argument is not XSDataString but %s"
                % graphFormat.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def outputFile(self, _outfileName):
        print(
            "WARNING: Method outputFile in class XSDataInputSaxsModeling is deprecated, please use instead exportToFile!"
        )
        self.exportToFile(_outfileName)
...
class XSDataInputSaxsPipeline(XSDataInput):
    ...
    def __init__(
        ...
        if fileSerie is None:
            ...
            strMessage = (
                "ERROR! XSDataInputSaxsPipeline constructor argument 'fileSerie' is not XSDataFileSeries but %s"
        ...
        if sample is None:
            ...
            strMessage = (
                "ERROR! XSDataInputSaxsPipeline constructor argument 'sample' is not XSDataBioSaxsSample but %s"
                % self._sample.__class__.__name__
            )
            raise BaseException(strMessage)
        if experimentSetup is None:
            ...
            strMessage = (
                "ERROR! XSDataInputSaxsPipeline constructor argument 'experimentSetup' is not XSDataBioSaxsExperimentSetup but %s"
        ...
        if directory1D is None:
            ...
            strMessage = (
                "ERROR! XSDataInputSaxsPipeline constructor argument 'directory1D' is not XSDataFile but %s"
        ...
        if directory2D is None:
            ...
            strMessage = (
                "ERROR! XSDataInputSaxsPipeline constructor argument 'directory2D' is not XSDataFile but %s"
        ...
        if directoryMisc is None:
            ...
            strMessage = (
                "ERROR! XSDataInputSaxsPipeline constructor argument 'directoryMisc' is not XSDataFile but %s"
        ...
        if forceReprocess is None:
            ...
            strMessage = (
                "ERROR! XSDataInputSaxsPipeline constructor argument 'forceReprocess' is not XSDataBoolean but %s"
        ...
        if absoluteFidelity is None:
            ...
            strMessage = (
                "ERROR! XSDataInputSaxsPipeline constructor argument 'absoluteFidelity' is not XSDataDouble but %s"
        ...
        if relativeFidelity is None:
            ...
            strMessage = (
                "ERROR! XSDataInputSaxsPipeline constructor argument 'relativeFidelity' is not XSDataDouble but %s"
        ...
        if rawImageSize is None:
            ...
            strMessage = (
                "ERROR! XSDataInputSaxsPipeline constructor argument 'rawImageSize' is not XSDataInteger but %s"
    ...
    def setFileSerie(self, fileSerie):
        if fileSerie is None:
            ...
            strMessage = (
                "ERROR! XSDataInputSaxsPipeline.setFileSerie argument is not XSDataFileSeries but %s"
    ...
    def setSample(self, sample):
        if sample is None:
            ...
            strMessage = (
                "ERROR! XSDataInputSaxsPipeline.setSample argument is not XSDataBioSaxsSample but %s"
                % sample.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setExperimentSetup(self, experimentSetup):
        if experimentSetup is None:
            ...
            strMessage = (
                "ERROR! XSDataInputSaxsPipeline.setExperimentSetup argument is not XSDataBioSaxsExperimentSetup but %s"
    ...
    def setDirectory1D(self, directory1D):
        if directory1D is None:
            ...
            strMessage = (
                "ERROR! XSDataInputSaxsPipeline.setDirectory1D argument is not XSDataFile but %s"
    ...
    def setDirectory2D(self, directory2D):
        if directory2D is None:
            ...
            strMessage = (
                "ERROR! XSDataInputSaxsPipeline.setDirectory2D argument is not XSDataFile but %s"
    ...
    def setDirectoryMisc(self, directoryMisc):
        if directoryMisc is None:
            ...
            strMessage = (
                "ERROR! XSDataInputSaxsPipeline.setDirectoryMisc argument is not XSDataFile but %s"
    ...
    def setForceReprocess(self, forceReprocess):
        if forceReprocess is None:
            ...
            strMessage = (
                "ERROR! XSDataInputSaxsPipeline.setForceReprocess argument is not XSDataBoolean but %s"
    ...
    def setAbsoluteFidelity(self, absoluteFidelity):
        if absoluteFidelity is None:
            ...
            strMessage = (
                "ERROR! XSDataInputSaxsPipeline.setAbsoluteFidelity argument is not XSDataDouble but %s"
    ...
    def setRelativeFidelity(self, relativeFidelity):
        if relativeFidelity is None:
            ...
            strMessage = (
                "ERROR! XSDataInputSaxsPipeline.setRelativeFidelity argument is not XSDataDouble but %s"
    ...
    def setRawImageSize(self, rawImageSize):
        if rawImageSize is None:
            ...
            strMessage = (
                "ERROR! XSDataInputSaxsPipeline.setRawImageSize argument is not XSDataInteger but %s"
    ...
    def outputFile(self, _outfileName):
        print(
            "WARNING: Method outputFile in class XSDataInputSaxsPipeline is deprecated, please use instead exportToFile!"
        )
        self.exportToFile(_outfileName)
...
class XSDataInputSupcomb(XSDataInput):
    ...
    def __init__(
        ...
        if templateFile is None:
            ...
            strMessage = (
                "ERROR! XSDataInputSupcomb constructor argument 'templateFile' is not XSDataFile but %s"
                % self._templateFile.__class__.__name__
            )
            raise BaseException(strMessage)
        if superimposeFile is None:
            ...
            strMessage = (
                "ERROR! XSDataInputSupcomb constructor argument 'superimposeFile' is not XSDataFile but %s"
                % self._superimposeFile.__class__.__name__
            )
            raise BaseException(strMessage)
        if enantiomorphs is None:
            ...
            strMessage = (
                "ERROR! XSDataInputSupcomb constructor argument 'enantiomorphs' is not XSDataBoolean but %s"
                % self._enantiomorphs.__class__.__name__
            )
            raise BaseException(strMessage)
        if backbone is None:
            self._backbone = None
            ...
            strMessage = (
                "ERROR! XSDataInputSupcomb constructor argument 'backbone' is not XSDataBoolean but %s"
                % self._backbone.__class__.__name__
            )
            raise BaseException(strMessage)
        if name is None:
            self._name = None
            ...
            strMessage = (
                "ERROR! XSDataInputSupcomb constructor argument 'name' is not XSDataString but %s"
                % self._name.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setTemplateFile(self, templateFile):
        if templateFile is None:
            ...
            strMessage = (
                "ERROR! XSDataInputSupcomb.setTemplateFile argument is not XSDataFile but %s"
                % templateFile.__class__.__name__
            )
            raise BaseException(strMessage)

    def delTemplateFile(self):
        self._templateFile = None

    templateFile = property(
        getTemplateFile, setTemplateFile, delTemplateFile, "Property for templateFile"
    )
    # Methods and properties for the 'superimposeFile' attribute
    def getSuperimposeFile(self):
        return self._superimposeFile
    ...
    def setSuperimposeFile(self, superimposeFile):
        if superimposeFile is None:
            ...
            strMessage = (
                "ERROR! XSDataInputSupcomb.setSuperimposeFile argument is not XSDataFile but %s"
                % superimposeFile.__class__.__name__
            )
            raise BaseException(strMessage)

    def delSuperimposeFile(self):
        self._superimposeFile = None

    superimposeFile = property(
        getSuperimposeFile,
        setSuperimposeFile,
        delSuperimposeFile,
        "Property for superimposeFile",
    )
    # Methods and properties for the 'enantiomorphs' attribute
    def getEnantiomorphs(self):
        return self._enantiomorphs
    ...
    def setEnantiomorphs(self, enantiomorphs):
        if enantiomorphs is None:
            ...
            strMessage = (
                "ERROR! XSDataInputSupcomb.setEnantiomorphs argument is not XSDataBoolean but %s"
                % enantiomorphs.__class__.__name__
            )
            raise BaseException(strMessage)

    def delEnantiomorphs(self):
        self._enantiomorphs = None

    enantiomorphs = property(
        getEnantiomorphs,
        setEnantiomorphs,
        delEnantiomorphs,
        "Property for enantiomorphs",
    )
    ...
    def setBackbone(self, backbone):
        if backbone is None:
            ...
            strMessage = (
                "ERROR! XSDataInputSupcomb.setBackbone argument is not XSDataBoolean but %s"
                % backbone.__class__.__name__
            )
            raise BaseException(strMessage)

    def delBackbone(self):
        self._backbone = None
    ...
    def setName(self, name):
        if name is None:
            ...
            strMessage = (
                "ERROR! XSDataInputSupcomb.setName argument is not XSDataString but %s"
                % name.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def buildChildren(self, child_, nodeName_):
        if child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "templateFile":
            obj_ = XSDataFile()
            obj_.build(child_)
            self.setTemplateFile(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "superimposeFile":
            obj_ = XSDataFile()
            obj_.build(child_)
            self.setSuperimposeFile(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "enantiomorphs":
            obj_ = XSDataBoolean()
            obj_.build(child_)
            self.setEnantiomorphs(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "backbone":
            obj_ = XSDataBoolean()
            obj_.build(child_)
    ...
    def outputFile(self, _outfileName):
        print(
            "WARNING: Method outputFile in class XSDataInputSupcomb is deprecated, please use instead exportToFile!"
        )
        self.exportToFile(_outfileName)
...
class XSDataResultAutoRg(XSDataResult):
    def __init__(self, status=None, autoRgOut=None):
        ...
        if autoRgOut is None:
            ...
            strMessage = (
                "ERROR! XSDataResultAutoRg constructor argument 'autoRgOut' is not list but %s"
                % self._autoRgOut.__class__.__name__
            )
            raise BaseException(strMessage)

    # Methods and properties for the 'autoRgOut' attribute
    def getAutoRgOut(self):
        return self._autoRgOut
    ...
    def setAutoRgOut(self, autoRgOut):
        if autoRgOut is None:
            ...
            strMessage = (
                "ERROR! XSDataResultAutoRg.setAutoRgOut argument is not list but %s"
                % autoRgOut.__class__.__name__
            )
            raise BaseException(strMessage)

    def delAutoRgOut(self):
        self._autoRgOut = None

    autoRgOut = property(
        getAutoRgOut, setAutoRgOut, delAutoRgOut, "Property for autoRgOut"
    )
    ...
    def addAutoRgOut(self, value):
        if value is None:
            ...
            strMessage = (
                "ERROR! XSDataResultAutoRg.addAutoRgOut argument is not XSDataAutoRg but %s"
                % value.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def insertAutoRgOut(self, index, value):
        if index is None:
            strMessage = (
                "ERROR! XSDataResultAutoRg.insertAutoRgOut argument 'index' is None"
            )
            raise BaseException(strMessage)
        if value is None:
            strMessage = (
                "ERROR! XSDataResultAutoRg.insertAutoRgOut argument 'value' is None"
            )
            raise BaseException(strMessage)
        elif value.__class__.__name__ == "XSDataAutoRg":
    ...
    def buildChildren(self, child_, nodeName_):
        if child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "autoRgOut":
            obj_ = XSDataAutoRg()
            obj_.build(child_)
    ...
    def outputFile(self, _outfileName):
        print(
            "WARNING: Method outputFile in class XSDataResultAutoRg is deprecated, please use instead exportToFile!"
        )
        self.exportToFile(_outfileName)
...
class XSDataResultAutoSub(XSDataResult):
    ...
    def __init__(
        ...
        if subtractedCurve is None:
            ...
            strMessage = (
                "ERROR! XSDataResultAutoSub constructor argument 'subtractedCurve' is not XSDataFile but %s"
                % self._subtractedCurve.__class__.__name__
            )
            raise BaseException(strMessage)
        if bestBuffer is None:
            ...
            strMessage = (
                "ERROR! XSDataResultAutoSub constructor argument 'bestBuffer' is not XSDataFile but %s"
        ...
        if bestBufferType is None:
            ...
            strMessage = (
                "ERROR! XSDataResultAutoSub constructor argument 'bestBufferType' is not XSDataString but %s"
                % self._bestBufferType.__class__.__name__
            )
            raise BaseException(strMessage)
        if autoRg is None:
            self._autoRg = None
            ...
            strMessage = (
                "ERROR! XSDataResultAutoSub constructor argument 'autoRg' is not XSDataAutoRg but %s"
                % self._autoRg.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setSubtractedCurve(self, subtractedCurve):
        if subtractedCurve is None:
            ...
            strMessage = (
                "ERROR! XSDataResultAutoSub.setSubtractedCurve argument is not XSDataFile but %s"
                % subtractedCurve.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setBestBuffer(self, bestBuffer):
        if bestBuffer is None:
            ...
            strMessage = (
                "ERROR! XSDataResultAutoSub.setBestBuffer argument is not XSDataFile but %s"
    ...
    def getBestBufferType(self):
        return self._bestBufferType
    ...
    def setBestBufferType(self, bestBufferType):
        if bestBufferType is None:
            ...
            strMessage = (
                "ERROR! XSDataResultAutoSub.setBestBufferType argument is not XSDataString but %s"
                % bestBufferType.__class__.__name__
            )
            raise BaseException(strMessage)

    def delBestBufferType(self):
        self._bestBufferType = None

    bestBufferType = property(
        getBestBufferType,
        setBestBufferType,
        delBestBufferType,
        "Property for bestBufferType",
    )
    # Methods and properties for the 'autoRg' attribute
    def getAutoRg(self):
        return self._autoRg
    ...
    def setAutoRg(self, autoRg):
        if autoRg is None:
            ...
            strMessage = (
                "ERROR! XSDataResultAutoSub.setAutoRg argument is not XSDataAutoRg but %s"
                % autoRg.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def buildChildren(self, child_, nodeName_):
        ...
        elif child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "bestBufferType":
            obj_ = XSDataString()
            obj_.build(child_)
    ...
    def outputFile(self, _outfileName):
        print(
            "WARNING: Method outputFile in class XSDataResultAutoSub is deprecated, please use instead exportToFile!"
        )
        self.exportToFile(_outfileName)
...
class XSDataResultDamaver(XSDataResult):
    def __init__(
        ...
        damfiltModel=None,
        model=None,
        damstartPdbFile=None,
        damfilterPdbFile=None,
        damaverPdbFile=None,
        variationNSD=None,
        meanNSD=None,
    ):
        ...
        if meanNSD is None:
            ...
            strMessage = (
                "ERROR! XSDataResultDamaver constructor argument 'meanNSD' is not XSDataDouble but %s"
                % self._meanNSD.__class__.__name__
            )
            raise BaseException(strMessage)
        if variationNSD is None:
            ...
            strMessage = (
                "ERROR! XSDataResultDamaver constructor argument 'variationNSD' is not XSDataDouble but %s"
                % self._variationNSD.__class__.__name__
            )
            raise BaseException(strMessage)
        if damaverPdbFile is None:
            ...
            strMessage = (
                "ERROR! XSDataResultDamaver constructor argument 'damaverPdbFile' is not XSDataFile but %s"
                % self._damaverPdbFile.__class__.__name__
            )
            raise BaseException(strMessage)
        if damfilterPdbFile is None:
            ...
            strMessage = (
                "ERROR! XSDataResultDamaver constructor argument 'damfilterPdbFile' is not XSDataFile but %s"
                % self._damfilterPdbFile.__class__.__name__
            )
            raise BaseException(strMessage)
        if damstartPdbFile is None:
            ...
            strMessage = (
                "ERROR! XSDataResultDamaver constructor argument 'damstartPdbFile' is not XSDataFile but %s"
                % self._damstartPdbFile.__class__.__name__
            )
            raise BaseException(strMessage)
        if model is None:
            self._model = None
            ...
            strMessage = (
                "ERROR! XSDataResultDamaver constructor argument 'model' is not XSDataSaxsModel but %s"
        ...
        if damfiltModel is None:
            ...
            strMessage = (
                "ERROR! XSDataResultDamaver constructor argument 'damfiltModel' is not XSDataSaxsModel but %s"
        ...
        if damstartModel is None:
            ...
            strMessage = (
                "ERROR! XSDataResultDamaver constructor argument 'damstartModel' is not XSDataSaxsModel but %s"
    ...
    def setMeanNSD(self, meanNSD):
        if meanNSD is None:
            ...
            strMessage = (
                "ERROR! XSDataResultDamaver.setMeanNSD argument is not XSDataDouble but %s"
                % meanNSD.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def getVariationNSD(self):
        return self._variationNSD
    ...
    def setVariationNSD(self, variationNSD):
        if variationNSD is None:
            ...
            strMessage = (
                "ERROR! XSDataResultDamaver.setVariationNSD argument is not XSDataDouble but %s"
                % variationNSD.__class__.__name__
            )
            raise BaseException(strMessage)

    def delVariationNSD(self):
        self._variationNSD = None

    variationNSD = property(
        getVariationNSD, setVariationNSD, delVariationNSD, "Property for variationNSD"
    )
    # Methods and properties for the 'damaverPdbFile' attribute
    def getDamaverPdbFile(self):
        return self._damaverPdbFile
    ...
    def setDamaverPdbFile(self, damaverPdbFile):
        if damaverPdbFile is None:
            ...
            strMessage = (
                "ERROR! XSDataResultDamaver.setDamaverPdbFile argument is not XSDataFile but %s"
                % damaverPdbFile.__class__.__name__
            )
            raise BaseException(strMessage)

    def delDamaverPdbFile(self):
        self._damaverPdbFile = None

    damaverPdbFile = property(
        getDamaverPdbFile,
        setDamaverPdbFile,
        delDamaverPdbFile,
        "Property for damaverPdbFile",
    )
    # Methods and properties for the 'damfilterPdbFile' attribute
    def getDamfilterPdbFile(self):
        return self._damfilterPdbFile
    ...
    def setDamfilterPdbFile(self, damfilterPdbFile):
        if damfilterPdbFile is None:
            ...
            strMessage = (
                "ERROR! XSDataResultDamaver.setDamfilterPdbFile argument is not XSDataFile but %s"
                % damfilterPdbFile.__class__.__name__
            )
            raise BaseException(strMessage)

    def delDamfilterPdbFile(self):
        self._damfilterPdbFile = None

    damfilterPdbFile = property(
        getDamfilterPdbFile,
        setDamfilterPdbFile,
        delDamfilterPdbFile,
        "Property for damfilterPdbFile",
    )
    # Methods and properties for the 'damstartPdbFile' attribute
    def getDamstartPdbFile(self):
        return self._damstartPdbFile
    ...
    def setDamstartPdbFile(self, damstartPdbFile):
        if damstartPdbFile is None:
            ...
            strMessage = (
                "ERROR! XSDataResultDamaver.setDamstartPdbFile argument is not XSDataFile but %s"
                % damstartPdbFile.__class__.__name__
            )
            raise BaseException(strMessage)

    def delDamstartPdbFile(self):
        self._damstartPdbFile = None

    damstartPdbFile = property(
        getDamstartPdbFile,
        setDamstartPdbFile,
        delDamstartPdbFile,
        "Property for damstartPdbFile",
    )
    ...
    def setModel(self, model):
        if model is None:
            ...
            strMessage = (
                "ERROR! XSDataResultDamaver.setModel argument is not XSDataSaxsModel but %s"
    ...
    def setDamfiltModel(self, damfiltModel):
        if damfiltModel is None:
            ...
            strMessage = (
                "ERROR! XSDataResultDamaver.setDamfiltModel argument is not XSDataSaxsModel but %s"
    ...
    def setDamstartModel(self, damstartModel):
        if damstartModel is None:
            ...
            strMessage = (
                "ERROR! XSDataResultDamaver.setDamstartModel argument is not XSDataSaxsModel but %s"
    ...
    def buildChildren(self, child_, nodeName_):
        if child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "meanNSD":
            obj_ = XSDataDouble()
            obj_.build(child_)
            self.setMeanNSD(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "variationNSD":
            obj_ = XSDataDouble()
            obj_.build(child_)
            self.setVariationNSD(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "damaverPdbFile":
            obj_ = XSDataFile()
            obj_.build(child_)
            self.setDamaverPdbFile(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "damfilterPdbFile":
            obj_ = XSDataFile()
            obj_.build(child_)
            self.setDamfilterPdbFile(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "damstartPdbFile":
            obj_ = XSDataFile()
            obj_.build(child_)
            self.setDamstartPdbFile(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "model":
    ...
    def outputFile(self, _outfileName):
        print(
            "WARNING: Method outputFile in class XSDataResultDamaver is deprecated, please use instead exportToFile!"
        )
        self.exportToFile(_outfileName)
...
class XSDataResultDamfilt(XSDataResult):
    def __init__(self, status=None, model=None, outputPdbFile=None):
        ...
        if outputPdbFile is None:
            ...
            strMessage = (
                "ERROR! XSDataResultDamfilt constructor argument 'outputPdbFile' is not XSDataFile but %s"
                % self._outputPdbFile.__class__.__name__
            )
            raise BaseException(strMessage)
        if model is None:
            self._model = None
            ...
            strMessage = (
                "ERROR! XSDataResultDamfilt constructor argument 'model' is not XSDataSaxsModel but %s"
                % self._model.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setOutputPdbFile(self, outputPdbFile):
        if outputPdbFile is None:
            ...
            strMessage = (
                "ERROR! XSDataResultDamfilt.setOutputPdbFile argument is not XSDataFile but %s"
                % outputPdbFile.__class__.__name__
            )
            raise BaseException(strMessage)

    def delOutputPdbFile(self):
        self._outputPdbFile = None

    outputPdbFile = property(
        getOutputPdbFile,
        setOutputPdbFile,
        delOutputPdbFile,
        "Property for outputPdbFile",
    )
    # Methods and properties for the 'model' attribute
    def getModel(self):
        return self._model
    ...
    def setModel(self, model):
        if model is None:
            ...
            strMessage = (
                "ERROR! XSDataResultDamfilt.setModel argument is not XSDataSaxsModel but %s"
                % model.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def buildChildren(self, child_, nodeName_):
        if child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "outputPdbFile":
            obj_ = XSDataFile()
            obj_.build(child_)
    ...
    def outputFile(self, _outfileName):
        print(
            "WARNING: Method outputFile in class XSDataResultDamfilt is deprecated, please use instead exportToFile!"
        )
        self.exportToFile(_outfileName)
...
class XSDataResultDammif(XSDataResult):
    def __init__(
        ...
        if fitFile is None:
            ...
            strMessage = (
                "ERROR! XSDataResultDammif constructor argument 'fitFile' is not XSDataFile but %s"
                % self._fitFile.__class__.__name__
            )
            raise BaseException(strMessage)
        if logFile is None:
            ...
            strMessage = (
                "ERROR! XSDataResultDammif constructor argument 'logFile' is not XSDataFile but %s"
                % self._logFile.__class__.__name__
            )
            raise BaseException(strMessage)
        if pdbMoleculeFile is None:
            ...
            strMessage = (
                "ERROR! XSDataResultDammif constructor argument 'pdbMoleculeFile' is not XSDataFile but %s"
        ...
        if pdbSolventFile is None:
            ...
            strMessage = (
                "ERROR! XSDataResultDammif constructor argument 'pdbSolventFile' is not XSDataFile but %s"
        ...
        if rfactor is None:
            ...
            strMessage = (
                "ERROR! XSDataResultDammif constructor argument 'rfactor' is not XSDataDouble but %s"
                % self._rfactor.__class__.__name__
            )
            raise BaseException(strMessage)
        if chiSqrt is None:
            ...
            strMessage = (
                "ERROR! XSDataResultDammif constructor argument 'chiSqrt' is not XSDataDouble but %s"
                % self._chiSqrt.__class__.__name__
            )
            raise BaseException(strMessage)
        if model is None:
            ...
            strMessage = (
                "ERROR! XSDataResultDammif constructor argument 'model' is not XSDataSaxsModel but %s"
                % self._model.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setFitFile(self, fitFile):
        if fitFile is None:
            ...
            strMessage = (
                "ERROR! XSDataResultDammif.setFitFile argument is not XSDataFile but %s"
                % fitFile.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setLogFile(self, logFile):
        if logFile is None:
            ...
            strMessage = (
                "ERROR! XSDataResultDammif.setLogFile argument is not XSDataFile but %s"
                % logFile.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setPdbMoleculeFile(self, pdbMoleculeFile):
        if pdbMoleculeFile is None:
            ...
            strMessage = (
                "ERROR! XSDataResultDammif.setPdbMoleculeFile argument is not XSDataFile but %s"
    ...
    def setPdbSolventFile(self, pdbSolventFile):
        if pdbSolventFile is None:
            ...
            strMessage = (
                "ERROR! XSDataResultDammif.setPdbSolventFile argument is not XSDataFile but %s"
    ...
    def setRfactor(self, rfactor):
        if rfactor is None:
            ...
            strMessage = (
                "ERROR! XSDataResultDammif.setRfactor argument is not XSDataDouble but %s"
                % rfactor.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setChiSqrt(self, chiSqrt):
        if chiSqrt is None:
            ...
            strMessage = (
                "ERROR! XSDataResultDammif.setChiSqrt argument is not XSDataDouble but %s"
                % chiSqrt.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setModel(self, model):
        if model is None:
            ...
            strMessage = (
                "ERROR! XSDataResultDammif.setModel argument is not XSDataSaxsModel but %s"
                % model.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def buildChildren(self, child_, nodeName_):
        if child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "fitFile":
            obj_ = XSDataFile()
            obj_.build(child_)
            self.setFitFile(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "logFile":
    ...
    def outputFile(self, _outfileName):
        print(
            "WARNING: Method outputFile in class XSDataResultDammif is deprecated, please use instead exportToFile!"
        )
        self.exportToFile(_outfileName)
...
class XSDataResultDammin(XSDataResult):
    def __init__(
        ...
        if fitFile is None:
            ...
            strMessage = (
                "ERROR! XSDataResultDammin constructor argument 'fitFile' is not XSDataFile but %s"
                % self._fitFile.__class__.__name__
            )
            raise BaseException(strMessage)
        if logFile is None:
            ...
            strMessage = (
                "ERROR! XSDataResultDammin constructor argument 'logFile' is not XSDataFile but %s"
                % self._logFile.__class__.__name__
            )
            raise BaseException(strMessage)
        if pdbMoleculeFile is None:
            ...
            strMessage = (
                "ERROR! XSDataResultDammin constructor argument 'pdbMoleculeFile' is not XSDataFile but %s"
                % self._pdbMoleculeFile.__class__.__name__
            )
            raise BaseException(strMessage)
        if pdbSolventFile is None:
            ...
            strMessage = (
                "ERROR! XSDataResultDammin constructor argument 'pdbSolventFile' is not XSDataFile but %s"
                % self._pdbSolventFile.__class__.__name__
            )
            raise BaseException(strMessage)
        if rfactor is None:
            ...
            strMessage = (
                "ERROR! XSDataResultDammin constructor argument 'rfactor' is not XSDataDouble but %s"
                % self._rfactor.__class__.__name__
            )
            raise BaseException(strMessage)
        if chiSqrt is None:
            ...
            strMessage = (
                "ERROR! XSDataResultDammin constructor argument 'chiSqrt' is not XSDataDouble but %s"
                % self._chiSqrt.__class__.__name__
            )
            raise BaseException(strMessage)
        if model is None:
            ...
            strMessage = (
                "ERROR! XSDataResultDammin constructor argument 'model' is not XSDataSaxsModel but %s"
                % self._model.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setFitFile(self, fitFile):
        if fitFile is None:
            ...
            strMessage = (
                "ERROR! XSDataResultDammin.setFitFile argument is not XSDataFile but %s"
                % fitFile.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setLogFile(self, logFile):
        if logFile is None:
            ...
            strMessage = (
                "ERROR! XSDataResultDammin.setLogFile argument is not XSDataFile but %s"
                % logFile.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setPdbMoleculeFile(self, pdbMoleculeFile):
        if pdbMoleculeFile is None:
            ...
            strMessage = (
                "ERROR! XSDataResultDammin.setPdbMoleculeFile argument is not XSDataFile but %s"
                % pdbMoleculeFile.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setPdbSolventFile(self, pdbSolventFile):
        if pdbSolventFile is None:
            ...
            strMessage = (
                "ERROR! XSDataResultDammin.setPdbSolventFile argument is not XSDataFile but %s"
                % pdbSolventFile.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setRfactor(self, rfactor):
        if rfactor is None:
            ...
            strMessage = (
                "ERROR! XSDataResultDammin.setRfactor argument is not XSDataDouble but %s"
                % rfactor.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setChiSqrt(self, chiSqrt):
        if chiSqrt is None:
            ...
            strMessage = (
                "ERROR! XSDataResultDammin.setChiSqrt argument is not XSDataDouble but %s"
                % chiSqrt.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setModel(self, model):
        if model is None:
            ...
            strMessage = (
                "ERROR! XSDataResultDammin.setModel argument is not XSDataSaxsModel but %s"
                % model.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def outputFile(self, _outfileName):
        print(
            "WARNING: Method outputFile in class XSDataResultDammin is deprecated, please use instead exportToFile!"
        )
        self.exportToFile(_outfileName)
...
class XSDataResultDamstart(XSDataResult):
    def __init__(self, status=None, model=None, outputPdbFile=None):
        ...
        if outputPdbFile is None:
            ...
            strMessage = (
                "ERROR! XSDataResultDamstart constructor argument 'outputPdbFile' is not XSDataFile but %s"
                % self._outputPdbFile.__class__.__name__
            )
            raise BaseException(strMessage)
        if model is None:
            ...
            strMessage = (
                "ERROR! XSDataResultDamstart constructor argument 'model' is not XSDataSaxsModel but %s"
                % self._model.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setOutputPdbFile(self, outputPdbFile):
        if outputPdbFile is None:
            ...
            strMessage = (
                "ERROR! XSDataResultDamstart.setOutputPdbFile argument is not XSDataFile but %s"
                % outputPdbFile.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setModel(self, model):
        if model is None:
            ...
            strMessage = (
                "ERROR! XSDataResultDamstart.setModel argument is not XSDataSaxsModel but %s"
                % model.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def outputFile(self, _outfileName):
        print(
            "WARNING: Method outputFile in class XSDataResultDamstart is deprecated, please use instead exportToFile!"
        )
        self.exportToFile(_outfileName)
...
class XSDataResultDatGnom(XSDataResult):
    def __init__(self, status=None, gnom=None):
        ...
        if gnom is None:
            ...
            strMessage = (
                "ERROR! XSDataResultDatGnom constructor argument 'gnom' is not XSDataGnom but %s"
    ...
    def setGnom(self, gnom):
        if gnom is None:
            ...
            strMessage = (
                "ERROR! XSDataResultDatGnom.setGnom argument is not XSDataGnom but %s"
    ...
    def buildChildren(self, child_, nodeName_):
        if child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "gnom":
            obj_ = XSDataGnom()
            obj_.build(child_)
            self.setGnom(obj_)
        XSDataResult.buildChildren(self, child_, nodeName_)
    ...
    def outputFile(self, _outfileName):
        print(
            "WARNING: Method outputFile in class XSDataResultDatGnom is deprecated, please use instead exportToFile!"
        )
        self.exportToFile(_outfileName)
...
class XSDataResultDatPorod(XSDataResult):
    def __init__(self, status=None, volume=None):
        ...
        if volume is None:
            ...
            strMessage = (
                "ERROR! XSDataResultDatPorod constructor argument 'volume' is not XSDataDoubleWithUnit but %s"
                % self._volume.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setVolume(self, volume):
        if volume is None:
            ...
            strMessage = (
                "ERROR! XSDataResultDatPorod.setVolume argument is not XSDataDoubleWithUnit but %s"
                % volume.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def buildChildren(self, child_, nodeName_):
        if child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "volume":
    ...
    def outputFile(self, _outfileName):
        print(
            "WARNING: Method outputFile in class XSDataResultDatPorod is deprecated, please use instead exportToFile!"
        )
        self.exportToFile(_outfileName)
...
class XSDataResultDataver(XSDataResult):
    ...
    def __init__(self, status=None, outputCurve=None):
        ...
        if outputCurve is None:
            ...
            strMessage = (
                "ERROR! XSDataResultDataver constructor argument 'outputCurve' is not XSDataFile but %s"
                % self._outputCurve.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setOutputCurve(self, outputCurve):
        if outputCurve is None:
            ...
            strMessage = (
                "ERROR! XSDataResultDataver.setOutputCurve argument is not XSDataFile but %s"
                % outputCurve.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def outputFile(self, _outfileName):
        print(
            "WARNING: Method outputFile in class XSDataResultDataver is deprecated, please use instead exportToFile!"
        )
        self.exportToFile(_outfileName)
...
class XSDataResultDatcmp(XSDataResult):
    ...
    def __init__(self, status=None, fidelity=None, chi=None):
        ...
        if chi is None:
            ...
            strMessage = (
                "ERROR! XSDataResultDatcmp constructor argument 'chi' is not XSDataDouble but %s"
                % self._chi.__class__.__name__
            )
            raise BaseException(strMessage)
        if fidelity is None:
            self._fidelity = None
            ...
            strMessage = (
                "ERROR! XSDataResultDatcmp constructor argument 'fidelity' is not XSDataDouble but %s"
                % self._fidelity.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setChi(self, chi):
        if chi is None:
            ...
            strMessage = (
                "ERROR! XSDataResultDatcmp.setChi argument is not XSDataDouble but %s"
                % chi.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setFidelity(self, fidelity):
        if fidelity is None:
            ...
            strMessage = (
                "ERROR! XSDataResultDatcmp.setFidelity argument is not XSDataDouble but %s"
                % fidelity.__class__.__name__
            )
            raise BaseException(strMessage)

    def delFidelity(self):
        self._fidelity = None
    ...
    def buildChildren(self, child_, nodeName_):
        if child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "chi":
            obj_ = XSDataDouble()
            obj_.build(child_)
            self.setChi(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "fidelity":
            obj_ = XSDataDouble()
            obj_.build(child_)
    ...
    def outputFile(self, _outfileName):
        print(
            "WARNING: Method outputFile in class XSDataResultDatcmp is deprecated, please use instead exportToFile!"
        )
        self.exportToFile(_outfileName)
...
class XSDataResultDatop(XSDataResult):
    ...
    def __init__(self, status=None, outputCurve=None):
        ...
        if outputCurve is None:
            ...
            strMessage = (
                "ERROR! XSDataResultDatop constructor argument 'outputCurve' is not XSDataFile but %s"
                % self._outputCurve.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setOutputCurve(self, outputCurve):
        if outputCurve is None:
            ...
            strMessage = (
                "ERROR! XSDataResultDatop.setOutputCurve argument is not XSDataFile but %s"
                % outputCurve.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def outputFile(self, _outfileName):
        print(
            "WARNING: Method outputFile in class XSDataResultDatop is deprecated, please use instead exportToFile!"
        )
        self.exportToFile(_outfileName)
...
class XSDataResultGnom(XSDataResult):
    def __init__(
        ...
        radiusOfCrossSection=None,
        arrayErr=None,
        arrayPr=None,
        arrayR=None,
        distributionErr=None,
        distributionPr=None,
        distributionR=None,
        scatteringFitIArray=None,
        scatteringFitQArray=None,
        scatteringFitValues=None,
        scatteringFitQ=None,
        output=None,
        fitQuality=None,
    ):
        ...
        if fitQuality is None:
            ...
            strMessage = (
                "ERROR! XSDataResultGnom constructor argument 'fitQuality' is not XSDataDouble but %s"
                % self._fitQuality.__class__.__name__
            )
            raise BaseException(strMessage)
        if output is None:
            self._output = None
            ...
            strMessage = (
                "ERROR! XSDataResultGnom constructor argument 'output' is not XSDataFile but %s"
                % self._output.__class__.__name__
            )
            raise BaseException(strMessage)
        if scatteringFitQ is None:
            ...
            strMessage = (
                "ERROR! XSDataResultGnom constructor argument 'scatteringFitQ' is not list but %s"
                % self._scatteringFitQ.__class__.__name__
            )
            raise BaseException(strMessage)
        if scatteringFitValues is None:
            ...
            strMessage = (
                "ERROR! XSDataResultGnom constructor argument 'scatteringFitValues' is not list but %s"
                % self._scatteringFitValues.__class__.__name__
            )
            raise BaseException(strMessage)
        if scatteringFitQArray is None:
            ...
            strMessage = (
                "ERROR! XSDataResultGnom constructor argument 'scatteringFitQArray' is not XSDataArray but %s"
                % self._scatteringFitQArray.__class__.__name__
            )
            raise BaseException(strMessage)
        if scatteringFitIArray is None:
            ...
            strMessage = (
                "ERROR! XSDataResultGnom constructor argument 'scatteringFitIArray' is not XSDataArray but %s"
                % self._scatteringFitIArray.__class__.__name__
            )
            raise BaseException(strMessage)
        if distributionR is None:
            ...
            strMessage = (
                "ERROR! XSDataResultGnom constructor argument 'distributionR' is not list but %s"
                % self._distributionR.__class__.__name__
            )
            raise BaseException(strMessage)
        if distributionPr is None:
            ...
            strMessage = (
                "ERROR! XSDataResultGnom constructor argument 'distributionPr' is not list but %s"
                % self._distributionPr.__class__.__name__
            )
            raise BaseException(strMessage)
        if distributionErr is None:
            ...
            strMessage = (
                "ERROR! XSDataResultGnom constructor argument 'distributionErr' is not list but %s"
                % self._distributionErr.__class__.__name__
            )
            raise BaseException(strMessage)
        if arrayR is None:
            self._arrayR = None
            ...
            strMessage = (
                "ERROR! XSDataResultGnom constructor argument 'arrayR' is not XSDataArray but %s"
                % self._arrayR.__class__.__name__
            )
            raise BaseException(strMessage)
        if arrayPr is None:
            self._arrayPr = None
            ...
            strMessage = (
                "ERROR! XSDataResultGnom constructor argument 'arrayPr' is not XSDataArray but %s"
                % self._arrayPr.__class__.__name__
            )
            raise BaseException(strMessage)
        if arrayErr is None:
            self._arrayErr = None
            ...
            strMessage = (
                "ERROR! XSDataResultGnom constructor argument 'arrayErr' is not XSDataArray but %s"
                % self._arrayErr.__class__.__name__
            )
            raise BaseException(strMessage)
        if radiusOfCrossSection is None:
            ...
            strMessage = (
                "ERROR! XSDataResultGnom constructor argument 'radiusOfCrossSection' is not XSDataDouble but %s"
                % self._radiusOfCrossSection.__class__.__name__
            )
            raise BaseException(strMessage)
        if radiusOfGyration is None:
            ...
            strMessage = (
                "ERROR! XSDataResultGnom constructor argument 'radiusOfGyration' is not XSDataDouble but %s"
                % self._radiusOfGyration.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setFitQuality(self, fitQuality):
        if fitQuality is None:
            ...
            strMessage = (
                "ERROR! XSDataResultGnom.setFitQuality argument is not XSDataDouble but %s"
                % fitQuality.__class__.__name__
            )
            raise BaseException(strMessage)

    def delFitQuality(self):
        self._fitQuality = None

    fitQuality = property(
        getFitQuality, setFitQuality, delFitQuality, "Property for fitQuality"
    )
    # Methods and properties for the 'output' attribute
    def getOutput(self):
        return self._output
    ...
    def setOutput(self, output):
        if output is None:
            ...
            strMessage = (
                "ERROR! XSDataResultGnom.setOutput argument is not XSDataFile but %s"
                % output.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def getScatteringFitQ(self):
        return self._scatteringFitQ
    ...
    def setScatteringFitQ(self, scatteringFitQ):
        if scatteringFitQ is None:
            ...
            strMessage = (
                "ERROR! XSDataResultGnom.setScatteringFitQ argument is not list but %s"
                % scatteringFitQ.__class__.__name__
            )
            raise BaseException(strMessage)

    def delScatteringFitQ(self):
        self._scatteringFitQ = None

    scatteringFitQ = property(
        getScatteringFitQ,
        setScatteringFitQ,
        delScatteringFitQ,
        "Property for scatteringFitQ",
    )
    ...
    def addScatteringFitQ(self, value):
        if value is None:
            ...
            strMessage = (
                "ERROR! XSDataResultGnom.addScatteringFitQ argument is not XSDataDouble but %s"
                % value.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def insertScatteringFitQ(self, index, value):
        if index is None:
            strMessage = (
                "ERROR! XSDataResultGnom.insertScatteringFitQ argument 'index' is None"
            )
            raise BaseException(strMessage)
        if value is None:
            strMessage = (
                "ERROR! XSDataResultGnom.insertScatteringFitQ argument 'value' is None"
            )
            raise BaseException(strMessage)
        elif value.__class__.__name__ == "XSDataDouble":
    ...
    def getScatteringFitValues(self):
        return self._scatteringFitValues
    ...
    def setScatteringFitValues(self, scatteringFitValues):
        if scatteringFitValues is None:
            ...
            strMessage = (
                "ERROR! XSDataResultGnom.setScatteringFitValues argument is not list but %s"
                % scatteringFitValues.__class__.__name__
            )
            raise BaseException(strMessage)

    def delScatteringFitValues(self):
        self._scatteringFitValues = None

    scatteringFitValues = property(
        getScatteringFitValues,
        setScatteringFitValues,
        delScatteringFitValues,
        "Property for scatteringFitValues",
    )

    def addScatteringFitValues(self, value):
        if value is None:
            strMessage = (
                "ERROR! XSDataResultGnom.addScatteringFitValues argument is None"
            )
            raise BaseException(strMessage)
        elif value.__class__.__name__ == "XSDataDouble":
            ...
            strMessage = (
                "ERROR! XSDataResultGnom.addScatteringFitValues argument is not XSDataDouble but %s"
                % value.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def getScatteringFitQArray(self):
        return self._scatteringFitQArray
    ...
    def setScatteringFitQArray(self, scatteringFitQArray):
        if scatteringFitQArray is None:
            ...
            strMessage = (
                "ERROR! XSDataResultGnom.setScatteringFitQArray argument is not XSDataArray but %s"
                % scatteringFitQArray.__class__.__name__
            )
            raise BaseException(strMessage)

    def delScatteringFitQArray(self):
        self._scatteringFitQArray = None

    scatteringFitQArray = property(
        getScatteringFitQArray,
        setScatteringFitQArray,
        delScatteringFitQArray,
        "Property for scatteringFitQArray",
    )
    # Methods and properties for the 'scatteringFitIArray' attribute
    def getScatteringFitIArray(self):
        return self._scatteringFitIArray
    ...
    def setScatteringFitIArray(self, scatteringFitIArray):
        if scatteringFitIArray is None:
            ...
            strMessage = (
                "ERROR! XSDataResultGnom.setScatteringFitIArray argument is not XSDataArray but %s"
                % scatteringFitIArray.__class__.__name__
            )
            raise BaseException(strMessage)

    def delScatteringFitIArray(self):
        self._scatteringFitIArray = None

    scatteringFitIArray = property(
        getScatteringFitIArray,
        setScatteringFitIArray,
        delScatteringFitIArray,
        "Property for scatteringFitIArray",
    )
    # Methods and properties for the 'distributionR' attribute
    def getDistributionR(self):
        return self._distributionR
    ...
    def setDistributionR(self, distributionR):
        if distributionR is None:
            ...
            strMessage = (
                "ERROR! XSDataResultGnom.setDistributionR argument is not list but %s"
                % distributionR.__class__.__name__
            )
            raise BaseException(strMessage)

    def delDistributionR(self):
        self._distributionR = None

    distributionR = property(
        getDistributionR,
        setDistributionR,
        delDistributionR,
        "Property for distributionR",
    )
    ...
    def addDistributionR(self, value):
        if value is None:
            ...
            strMessage = (
                "ERROR! XSDataResultGnom.addDistributionR argument is not XSDataDouble but %s"
                % value.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def insertDistributionR(self, index, value):
        if index is None:
            strMessage = (
                "ERROR! XSDataResultGnom.insertDistributionR argument 'index' is None"
            )
            raise BaseException(strMessage)
        if value is None:
            strMessage = (
                "ERROR! XSDataResultGnom.insertDistributionR argument 'value' is None"
            )
            raise BaseException(strMessage)
        elif value.__class__.__name__ == "XSDataDouble":
    ...
    def getDistributionPr(self):
        return self._distributionPr
    ...
    def setDistributionPr(self, distributionPr):
        if distributionPr is None:
            ...
            strMessage = (
                "ERROR! XSDataResultGnom.setDistributionPr argument is not list but %s"
                % distributionPr.__class__.__name__
            )
            raise BaseException(strMessage)

    def delDistributionPr(self):
        self._distributionPr = None

    distributionPr = property(
        getDistributionPr,
        setDistributionPr,
        delDistributionPr,
        "Property for distributionPr",
    )
    ...
    def addDistributionPr(self, value):
        if value is None:
            ...
            strMessage = (
                "ERROR! XSDataResultGnom.addDistributionPr argument is not XSDataDouble but %s"
                % value.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def insertDistributionPr(self, index, value):
        if index is None:
            strMessage = (
                "ERROR! XSDataResultGnom.insertDistributionPr argument 'index' is None"
            )
            raise BaseException(strMessage)
        if value is None:
            strMessage = (
                "ERROR! XSDataResultGnom.insertDistributionPr argument 'value' is None"
            )
            raise BaseException(strMessage)
        elif value.__class__.__name__ == "XSDataDouble":
    ...
    def getDistributionErr(self):
        return self._distributionErr
    ...
    def setDistributionErr(self, distributionErr):
        if distributionErr is None:
            ...
            strMessage = (
                "ERROR! XSDataResultGnom.setDistributionErr argument is not list but %s"
                % distributionErr.__class__.__name__
            )
            raise BaseException(strMessage)

    def delDistributionErr(self):
        self._distributionErr = None

    distributionErr = property(
        getDistributionErr,
        setDistributionErr,
        delDistributionErr,
        "Property for distributionErr",
    )
    ...
    def addDistributionErr(self, value):
        if value is None:
            ...
            strMessage = (
                "ERROR! XSDataResultGnom.addDistributionErr argument is not XSDataDouble but %s"
                % value.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def insertDistributionErr(self, index, value):
        if index is None:
            strMessage = (
                "ERROR! XSDataResultGnom.insertDistributionErr argument 'index' is None"
            )
            raise BaseException(strMessage)
        if value is None:
            strMessage = (
                "ERROR! XSDataResultGnom.insertDistributionErr argument 'value' is None"
            )
            raise BaseException(strMessage)
        elif value.__class__.__name__ == "XSDataDouble":
    ...
    def setArrayR(self, arrayR):
        if arrayR is None:
            ...
            strMessage = (
                "ERROR! XSDataResultGnom.setArrayR argument is not XSDataArray but %s"
                % arrayR.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setArrayPr(self, arrayPr):
        if arrayPr is None:
            ...
            strMessage = (
                "ERROR! XSDataResultGnom.setArrayPr argument is not XSDataArray but %s"
                % arrayPr.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def getArrayErr(self):
        return self._arrayErr
    ...
    def setArrayErr(self, arrayErr):
        if arrayErr is None:
            ...
            strMessage = (
                "ERROR! XSDataResultGnom.setArrayErr argument is not XSDataArray but %s"
                % arrayErr.__class__.__name__
            )
            raise BaseException(strMessage)

    def delArrayErr(self):
        self._arrayErr = None
    ...
    def getRadiusOfCrossSection(self):
        return self._radiusOfCrossSection
    ...
    def setRadiusOfCrossSection(self, radiusOfCrossSection):
        if radiusOfCrossSection is None:
            ...
            strMessage = (
                "ERROR! XSDataResultGnom.setRadiusOfCrossSection argument is not XSDataDouble but %s"
                % radiusOfCrossSection.__class__.__name__
            )
            raise BaseException(strMessage)

    def delRadiusOfCrossSection(self):
        self._radiusOfCrossSection = None

    radiusOfCrossSection = property(
        getRadiusOfCrossSection,
        setRadiusOfCrossSection,
        delRadiusOfCrossSection,
        "Property for radiusOfCrossSection",
    )
    # Methods and properties for the 'radiusOfGyration' attribute
    def getRadiusOfGyration(self):
        return self._radiusOfGyration
    ...
    def setRadiusOfGyration(self, radiusOfGyration):
        if radiusOfGyration is None:
            ...
            strMessage = (
                "ERROR! XSDataResultGnom.setRadiusOfGyration argument is not XSDataDouble but %s"
                % radiusOfGyration.__class__.__name__
            )
            raise BaseException(strMessage)

    def delRadiusOfGyration(self):
        self._radiusOfGyration = None

    radiusOfGyration = property(
        getRadiusOfGyration,
        setRadiusOfGyration,
        delRadiusOfGyration,
        "Property for radiusOfGyration",
    )
    ...
    def exportChildren(self, outfile, level, name_="XSDataResultGnom"):
        ...
        if self._radiusOfCrossSection is not None:
            self.radiusOfCrossSection.export(
                outfile, level, name_="radiusOfCrossSection"
            )
        else:
    ...
    def buildChildren(self, child_, nodeName_):
        if child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "fitQuality":
            obj_ = XSDataDouble()
            obj_.build(child_)
            ...
            obj_.build(child_)
            self.setOutput(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "scatteringFitQ":
            obj_ = XSDataDouble()
            obj_.build(child_)
            self.scatteringFitQ.append(obj_)
        elif (
            child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "scatteringFitValues"
        ):
            obj_ = XSDataDouble()
            obj_.build(child_)
            self.scatteringFitValues.append(obj_)
        elif (
            child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "scatteringFitQArray"
        ):
            obj_ = XSDataArray()
            obj_.build(child_)
            self.setScatteringFitQArray(obj_)
        elif (
            child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "scatteringFitIArray"
        ):
            obj_ = XSDataArray()
            obj_.build(child_)
            self.setScatteringFitIArray(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "distributionR":
            obj_ = XSDataDouble()
            obj_.build(child_)
            self.distributionR.append(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "distributionPr":
            obj_ = XSDataDouble()
            obj_.build(child_)
            self.distributionPr.append(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "distributionErr":
            obj_ = XSDataDouble()
            obj_.build(child_)
            self.distributionErr.append(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "arrayR":
            obj_ = XSDataArray()
            obj_.build(child_)
            self.setArrayR(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "arrayPr":
            obj_ = XSDataArray()
            obj_.build(child_)
            self.setArrayPr(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "arrayErr":
            obj_ = XSDataArray()
            obj_.build(child_)
            self.setArrayErr(obj_)
        elif (
            child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "radiusOfCrossSection"
        ):
            obj_ = XSDataDouble()
            obj_.build(child_)
            self.setRadiusOfCrossSection(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "radiusOfGyration":
            obj_ = XSDataDouble()
            obj_.build(child_)
    ...
    def outputFile(self, _outfileName):
        print(
            "WARNING: Method outputFile in class XSDataResultGnom is deprecated, please use instead exportToFile!"
        )
        self.exportToFile(_outfileName)
...
class XSDataResultSaxsAnalysis(XSDataResult):
    ...
    def __init__(
        ...
        if autoRg is None:
            ...
            strMessage = (
                "ERROR! XSDataResultSaxsAnalysis constructor argument 'autoRg' is not XSDataAutoRg but %s"
                % self._autoRg.__class__.__name__
            )
            raise BaseException(strMessage)
        if gnom is None:
            ...
            strMessage = (
                "ERROR! XSDataResultSaxsAnalysis constructor argument 'gnom' is not XSDataGnom but %s"
                % self._gnom.__class__.__name__
            )
            raise BaseException(strMessage)
        if volume is None:
            ...
            strMessage = (
                "ERROR! XSDataResultSaxsAnalysis constructor argument 'volume' is not XSDataDoubleWithUnit but %s"
                % self._volume.__class__.__name__
            )
            raise BaseException(strMessage)
        if scatterPlot is None:
            ...
            strMessage = (
                "ERROR! XSDataResultSaxsAnalysis constructor argument 'scatterPlot' is not XSDataFile but %s"
        ...
        if guinierPlot is None:
            ...
            strMessage = (
                "ERROR! XSDataResultSaxsAnalysis constructor argument 'guinierPlot' is not XSDataFile but %s"
        ...
        if kratkyPlot is None:
            ...
            strMessage = (
                "ERROR! XSDataResultSaxsAnalysis constructor argument 'kratkyPlot' is not XSDataFile but %s"
        ...
        if densityPlot is None:
            ...
            strMessage = (
                "ERROR! XSDataResultSaxsAnalysis constructor argument 'densityPlot' is not XSDataFile but %s"
    ...
    def setAutoRg(self, autoRg):
        if autoRg is None:
            ...
            strMessage = (
                "ERROR! XSDataResultSaxsAnalysis.setAutoRg argument is not XSDataAutoRg but %s"
                % autoRg.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setGnom(self, gnom):
        if gnom is None:
            ...
            strMessage = (
                "ERROR! XSDataResultSaxsAnalysis.setGnom argument is not XSDataGnom but %s"
                % gnom.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setVolume(self, volume):
        if volume is None:
            ...
            strMessage = (
                "ERROR! XSDataResultSaxsAnalysis.setVolume argument is not XSDataDoubleWithUnit but %s"
                % volume.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setScatterPlot(self, scatterPlot):
        if scatterPlot is None:
            ...
            strMessage = (
                "ERROR! XSDataResultSaxsAnalysis.setScatterPlot argument is not XSDataFile but %s"
    ...
    def setGuinierPlot(self, guinierPlot):
        if guinierPlot is None:
            ...
            strMessage = (
                "ERROR! XSDataResultSaxsAnalysis.setGuinierPlot argument is not XSDataFile but %s"
    ...
    def setKratkyPlot(self, kratkyPlot):
        if kratkyPlot is None:
            ...
            strMessage = (
                "ERROR! XSDataResultSaxsAnalysis.setKratkyPlot argument is not XSDataFile but %s"
    ...
    def setDensityPlot(self, densityPlot):
        if densityPlot is None:
            ...
            strMessage = (
                "ERROR! XSDataResultSaxsAnalysis.setDensityPlot argument is not XSDataFile but %s"
    ...
    def buildChildren(self, child_, nodeName_):
        if child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "autoRg":
            obj_ = XSDataAutoRg()
            obj_.build(child_)
            self.setAutoRg(obj_)
    ...
    def outputFile(self, _outfileName):
        print(
            "WARNING: Method outputFile in class XSDataResultSaxsAnalysis is deprecated, please use instead exportToFile!"
        )
        self.exportToFile(_outfileName)
...
class XSDataResultSaxsAnalysisModeling(XSDataResult):
    ...
    def __init__(
        ...
        if autoRg is None:
            ...
            strMessage = (
                "ERROR! XSDataResultSaxsAnalysisModeling constructor argument 'autoRg' is not XSDataAutoRg but %s"
                % self._autoRg.__class__.__name__
            )
            raise BaseException(strMessage)
        if gnom is None:
            ...
            strMessage = (
                "ERROR! XSDataResultSaxsAnalysisModeling constructor argument 'gnom' is not XSDataGnom but %s"
                % self._gnom.__class__.__name__
            )
            raise BaseException(strMessage)
        if volume is None:
            ...
            strMessage = (
                "ERROR! XSDataResultSaxsAnalysisModeling constructor argument 'volume' is not XSDataDoubleWithUnit but %s"
                % self._volume.__class__.__name__
            )
            raise BaseException(strMessage)
        if scatterPlot is None:
            ...
            strMessage = (
                "ERROR! XSDataResultSaxsAnalysisModeling constructor argument 'scatterPlot' is not XSDataFile but %s"
                % self._scatterPlot.__class__.__name__
            )
            raise BaseException(strMessage)
        if guinierPlot is None:
            ...
            strMessage = (
                "ERROR! XSDataResultSaxsAnalysisModeling constructor argument 'guinierPlot' is not XSDataFile but %s"
                % self._guinierPlot.__class__.__name__
            )
            raise BaseException(strMessage)
        if kratkyPlot is None:
            ...
            strMessage = (
                "ERROR! XSDataResultSaxsAnalysisModeling constructor argument 'kratkyPlot' is not XSDataFile but %s"
                % self._kratkyPlot.__class__.__name__
            )
            raise BaseException(strMessage)
        if densityPlot is None:
            ...
            strMessage = (
                "ERROR! XSDataResultSaxsAnalysisModeling constructor argument 'densityPlot' is not XSDataFile but %s"
                % self._densityPlot.__class__.__name__
            )
            raise BaseException(strMessage)
        if dammifModels is None:
            ...
            strMessage = (
                "ERROR! XSDataResultSaxsAnalysisModeling constructor argument 'dammifModels' is not list but %s"
        ...
        if damaverModel is None:
            ...
            strMessage = (
                "ERROR! XSDataResultSaxsAnalysisModeling constructor argument 'damaverModel' is not XSDataSaxsModel but %s"
        ...
        if damfiltModel is None:
            ...
            strMessage = (
                "ERROR! XSDataResultSaxsAnalysisModeling constructor argument 'damfiltModel' is not XSDataSaxsModel but %s"
                % self._damfiltModel.__class__.__name__
            )
            raise BaseException(strMessage)
        if damstartModel is None:
            ...
            strMessage = (
                "ERROR! XSDataResultSaxsAnalysisModeling constructor argument 'damstartModel' is not XSDataSaxsModel but %s"
                % self._damstartModel.__class__.__name__
            )
            raise BaseException(strMessage)
        if damminModel is None:
            ...
            strMessage = (
                "ERROR! XSDataResultSaxsAnalysisModeling constructor argument 'damminModel' is not XSDataSaxsModel but %s"
        ...
        if chiRfactorPlot is None:
            ...
            strMessage = (
                "ERROR! XSDataResultSaxsAnalysisModeling constructor argument 'chiRfactorPlot' is not XSDataFile but %s"
        ...
        if nsdPlot is None:
            ...
            strMessage = (
                "ERROR! XSDataResultSaxsAnalysisModeling constructor argument 'nsdPlot' is not XSDataFile but %s"
        ...
        if fitFile is None:
            ...
            strMessage = (
                "ERROR! XSDataResultSaxsAnalysisModeling constructor argument 'fitFile' is not XSDataFile but %s"
                % self._fitFile.__class__.__name__
            )
            raise BaseException(strMessage)
        if logFile is None:
            ...
            strMessage = (
                "ERROR! XSDataResultSaxsAnalysisModeling constructor argument 'logFile' is not XSDataFile but %s"
                % self._logFile.__class__.__name__
            )
            raise BaseException(strMessage)
        if pdbMoleculeFile is None:
            ...
            strMessage = (
                "ERROR! XSDataResultSaxsAnalysisModeling constructor argument 'pdbMoleculeFile' is not XSDataFile but %s"
                % self._pdbMoleculeFile.__class__.__name__
            )
            raise BaseException(strMessage)
        if pdbSolventFile is None:
            ...
            strMessage = (
                "ERROR! XSDataResultSaxsAnalysisModeling constructor argument 'pdbSolventFile' is not XSDataFile but %s"
                % self._pdbSolventFile.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setAutoRg(self, autoRg):
        if autoRg is None:
            ...
            strMessage = (
                "ERROR! XSDataResultSaxsAnalysisModeling.setAutoRg argument is not XSDataAutoRg but %s"
                % autoRg.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setGnom(self, gnom):
        if gnom is None:
            ...
            strMessage = (
                "ERROR! XSDataResultSaxsAnalysisModeling.setGnom argument is not XSDataGnom but %s"
                % gnom.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setVolume(self, volume):
        if volume is None:
            ...
            strMessage = (
                "ERROR! XSDataResultSaxsAnalysisModeling.setVolume argument is not XSDataDoubleWithUnit but %s"
                % volume.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setScatterPlot(self, scatterPlot):
        if scatterPlot is None:
            ...
            strMessage = (
                "ERROR! XSDataResultSaxsAnalysisModeling.setScatterPlot argument is not XSDataFile but %s"
                % scatterPlot.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setGuinierPlot(self, guinierPlot):
        if guinierPlot is None:
            ...
            strMessage = (
                "ERROR! XSDataResultSaxsAnalysisModeling.setGuinierPlot argument is not XSDataFile but %s"
                % guinierPlot.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setKratkyPlot(self, kratkyPlot):
        if kratkyPlot is None:
            ...
            strMessage = (
                "ERROR! XSDataResultSaxsAnalysisModeling.setKratkyPlot argument is not XSDataFile but %s"
                % kratkyPlot.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setDensityPlot(self, densityPlot):
        if densityPlot is None:
            ...
            strMessage = (
                "ERROR! XSDataResultSaxsAnalysisModeling.setDensityPlot argument is not XSDataFile but %s"
                % densityPlot.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setDammifModels(self, dammifModels):
        if dammifModels is None:
            ...
            strMessage = (
                "ERROR! XSDataResultSaxsAnalysisModeling.setDammifModels argument is not list but %s"
    ...
    def addDammifModels(self, value):
        if value is None:
            ...
            strMessage = (
                "ERROR! XSDataResultSaxsAnalysisModeling.addDammifModels argument is not XSDataSaxsModel but %s"
                % value.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setDamaverModel(self, damaverModel):
        if damaverModel is None:
            ...
            strMessage = (
                "ERROR! XSDataResultSaxsAnalysisModeling.setDamaverModel argument is not XSDataSaxsModel but %s"
    ...
    def setDamfiltModel(self, damfiltModel):
        if damfiltModel is None:
            ...
            strMessage = (
                "ERROR! XSDataResultSaxsAnalysisModeling.setDamfiltModel argument is not XSDataSaxsModel but %s"
                % damfiltModel.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setDamstartModel(self, damstartModel):
        if damstartModel is None:
            ...
            strMessage = (
                "ERROR! XSDataResultSaxsAnalysisModeling.setDamstartModel argument is not XSDataSaxsModel but %s"
                % damstartModel.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setDamminModel(self, damminModel):
        if damminModel is None:
            ...
            strMessage = (
                "ERROR! XSDataResultSaxsAnalysisModeling.setDamminModel argument is not XSDataSaxsModel but %s"
    ...
    def setChiRfactorPlot(self, chiRfactorPlot):
        if chiRfactorPlot is None:
            ...
            strMessage = (
                "ERROR! XSDataResultSaxsAnalysisModeling.setChiRfactorPlot argument is not XSDataFile but %s"
    ...
    def setNsdPlot(self, nsdPlot):
        if nsdPlot is None:
            ...
            strMessage = (
                "ERROR! XSDataResultSaxsAnalysisModeling.setNsdPlot argument is not XSDataFile but %s"
    ...
    def setFitFile(self, fitFile):
        if fitFile is None:
            ...
            strMessage = (
                "ERROR! XSDataResultSaxsAnalysisModeling.setFitFile argument is not XSDataFile but %s"
                % fitFile.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setLogFile(self, logFile):
        if logFile is None:
            ...
            strMessage = (
                "ERROR! XSDataResultSaxsAnalysisModeling.setLogFile argument is not XSDataFile but %s"
                % logFile.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setPdbMoleculeFile(self, pdbMoleculeFile):
        if pdbMoleculeFile is None:
            ...
            strMessage = (
                "ERROR! XSDataResultSaxsAnalysisModeling.setPdbMoleculeFile argument is not XSDataFile but %s"
                % pdbMoleculeFile.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setPdbSolventFile(self, pdbSolventFile):
        if pdbSolventFile is None:
            ...
            strMessage = (
                "ERROR! XSDataResultSaxsAnalysisModeling.setPdbSolventFile argument is not XSDataFile but %s"
                % pdbSolventFile.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def outputFile(self, _outfileName):
        print(
            "WARNING: Method outputFile in class XSDataResultSaxsAnalysisModeling is deprecated, please use instead exportToFile!"
        )
        self.exportToFile(_outfileName)
...
class XSDataResultSaxsModeling(XSDataResult):
    ...
    def __init__(
        ...
        if dammifModels is None:
            ...
            strMessage = (
                "ERROR! XSDataResultSaxsModeling constructor argument 'dammifModels' is not list but %s"
                % self._dammifModels.__class__.__name__
            )
            raise BaseException(strMessage)
        if damaverModel is None:
            ...
            strMessage = (
                "ERROR! XSDataResultSaxsModeling constructor argument 'damaverModel' is not XSDataSaxsModel but %s"
                % self._damaverModel.__class__.__name__
            )
            raise BaseException(strMessage)
        if damfiltModel is None:
            ...
            strMessage = (
                "ERROR! XSDataResultSaxsModeling constructor argument 'damfiltModel' is not XSDataSaxsModel but %s"
                % self._damfiltModel.__class__.__name__
            )
            raise BaseException(strMessage)
        if damstartModel is None:
            ...
            strMessage = (
                "ERROR! XSDataResultSaxsModeling constructor argument 'damstartModel' is not XSDataSaxsModel but %s"
                % self._damstartModel.__class__.__name__
            )
            raise BaseException(strMessage)
        if damminModel is None:
            ...
            strMessage = (
                "ERROR! XSDataResultSaxsModeling constructor argument 'damminModel' is not XSDataSaxsModel but %s"
                % self._damminModel.__class__.__name__
            )
            raise BaseException(strMessage)
        if fitFile is None:
            ...
            strMessage = (
                "ERROR! XSDataResultSaxsModeling constructor argument 'fitFile' is not XSDataFile but %s"
                % self._fitFile.__class__.__name__
            )
            raise BaseException(strMessage)
        if logFile is None:
            ...
            strMessage = (
                "ERROR! XSDataResultSaxsModeling constructor argument 'logFile' is not XSDataFile but %s"
                % self._logFile.__class__.__name__
            )
            raise BaseException(strMessage)
        if pdbMoleculeFile is None:
            ...
            strMessage = (
                "ERROR! XSDataResultSaxsModeling constructor argument 'pdbMoleculeFile' is not XSDataFile but %s"
                % self._pdbMoleculeFile.__class__.__name__
            )
            raise BaseException(strMessage)
        if pdbSolventFile is None:
            ...
            strMessage = (
                "ERROR! XSDataResultSaxsModeling constructor argument 'pdbSolventFile' is not XSDataFile but %s"
                % self._pdbSolventFile.__class__.__name__
            )
            raise BaseException(strMessage)
        if chiRfactorPlot is None:
            ...
            strMessage = (
                "ERROR! XSDataResultSaxsModeling constructor argument 'chiRfactorPlot' is not XSDataFile but %s"
                % self._chiRfactorPlot.__class__.__name__
            )
            raise BaseException(strMessage)
        if nsdPlot is None:
            ...
            strMessage = (
                "ERROR! XSDataResultSaxsModeling constructor argument 'nsdPlot' is not XSDataFile but %s"
                % self._nsdPlot.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setDammifModels(self, dammifModels):
        if dammifModels is None:
            ...
            strMessage = (
                "ERROR! XSDataResultSaxsModeling.setDammifModels argument is not list but %s"
                % dammifModels.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def addDammifModels(self, value):
        if value is None:
            strMessage = (
                "ERROR! XSDataResultSaxsModeling.addDammifModels argument is None"
            )
            raise BaseException(strMessage)
        elif value.__class__.__name__ == "XSDataSaxsModel":
            self._dammifModels.append(value)
            ...
            strMessage = (
                "ERROR! XSDataResultSaxsModeling.addDammifModels argument is not XSDataSaxsModel but %s"
                % value.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setDamaverModel(self, damaverModel):
        if damaverModel is None:
            ...
            strMessage = (
                "ERROR! XSDataResultSaxsModeling.setDamaverModel argument is not XSDataSaxsModel but %s"
                % damaverModel.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setDamfiltModel(self, damfiltModel):
        if damfiltModel is None:
            ...
            strMessage = (
                "ERROR! XSDataResultSaxsModeling.setDamfiltModel argument is not XSDataSaxsModel but %s"
                % damfiltModel.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setDamstartModel(self, damstartModel):
        if damstartModel is None:
            ...
            strMessage = (
                "ERROR! XSDataResultSaxsModeling.setDamstartModel argument is not XSDataSaxsModel but %s"
                % damstartModel.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setDamminModel(self, damminModel):
        if damminModel is None:
            ...
            strMessage = (
                "ERROR! XSDataResultSaxsModeling.setDamminModel argument is not XSDataSaxsModel but %s"
                % damminModel.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setFitFile(self, fitFile):
        if fitFile is None:
            ...
            strMessage = (
                "ERROR! XSDataResultSaxsModeling.setFitFile argument is not XSDataFile but %s"
                % fitFile.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setLogFile(self, logFile):
        if logFile is None:
            ...
            strMessage = (
                "ERROR! XSDataResultSaxsModeling.setLogFile argument is not XSDataFile but %s"
                % logFile.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setPdbMoleculeFile(self, pdbMoleculeFile):
        if pdbMoleculeFile is None:
            ...
            strMessage = (
                "ERROR! XSDataResultSaxsModeling.setPdbMoleculeFile argument is not XSDataFile but %s"
                % pdbMoleculeFile.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setPdbSolventFile(self, pdbSolventFile):
        if pdbSolventFile is None:
            ...
            strMessage = (
                "ERROR! XSDataResultSaxsModeling.setPdbSolventFile argument is not XSDataFile but %s"
                % pdbSolventFile.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setChiRfactorPlot(self, chiRfactorPlot):
        if chiRfactorPlot is None:
            ...
            strMessage = (
                "ERROR! XSDataResultSaxsModeling.setChiRfactorPlot argument is not XSDataFile but %s"
                % chiRfactorPlot.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setNsdPlot(self, nsdPlot):
        if nsdPlot is None:
            ...
            strMessage = (
                "ERROR! XSDataResultSaxsModeling.setNsdPlot argument is not XSDataFile but %s"
                % nsdPlot.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def buildChildren(self, child_, nodeName_):
        if child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "dammifModels":
            obj_ = XSDataSaxsModel()
            obj_.build(child_)
            self.dammifModels.append(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "damaverModel":
    ...
    def outputFile(self, _outfileName):
        print(
            "WARNING: Method outputFile in class XSDataResultSaxsModeling is deprecated, please use instead exportToFile!"
        )
        self.exportToFile(_outfileName)
...
class XSDataResultSaxsPipeline(XSDataResult):
    def __init__(self, status=None, autoRgOut=None):
        ...
        if autoRgOut is None:
            ...
            strMessage = (
                "ERROR! XSDataResultSaxsPipeline constructor argument 'autoRgOut' is not list but %s"
                % self._autoRgOut.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setAutoRgOut(self, autoRgOut):
        if autoRgOut is None:
            ...
            strMessage = (
                "ERROR! XSDataResultSaxsPipeline.setAutoRgOut argument is not list but %s"
                % autoRgOut.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def addAutoRgOut(self, value):
        if value is None:
            ...
            strMessage = (
                "ERROR! XSDataResultSaxsPipeline.addAutoRgOut argument is not XSDataAutoRg but %s"
                % value.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def outputFile(self, _outfileName):
        print(
            "WARNING: Method outputFile in class XSDataResultSaxsPipeline is deprecated, please use instead exportToFile!"
        )
        self.exportToFile(_outfileName)
...
class XSDataResultSupcomb(XSDataResult):
    ...
    def __init__(
        ...
        if outputFilename is None:
            ...
            strMessage = (
                "ERROR! XSDataResultSupcomb constructor argument 'outputFilename' is not XSDataFile but %s"
                % self._outputFilename.__class__.__name__
            )
            raise BaseException(strMessage)
        if rot is None:
            self._rot = None
            ...
            strMessage = (
                "ERROR! XSDataResultSupcomb constructor argument 'rot' is not XSDataRotation but %s"
                % self._rot.__class__.__name__
            )
            raise BaseException(strMessage)
        if trns is None:
            self._trns = None
            ...
            strMessage = (
                "ERROR! XSDataResultSupcomb constructor argument 'trns' is not XSDataVectorDouble but %s"
                % self._trns.__class__.__name__
            )
            raise BaseException(strMessage)
        if NSD is None:
            self._NSD = None
            ...
            strMessage = (
                "ERROR! XSDataResultSupcomb constructor argument 'NSD' is not XSDataDouble but %s"
                % self._NSD.__class__.__name__
            )
            raise BaseException(strMessage)
        if model is None:
            self._model = None
            ...
            strMessage = (
                "ERROR! XSDataResultSupcomb constructor argument 'model' is not XSDataSaxsModel but %s"
                % self._model.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setOutputFilename(self, outputFilename):
        if outputFilename is None:
            ...
            strMessage = (
                "ERROR! XSDataResultSupcomb.setOutputFilename argument is not XSDataFile but %s"
                % outputFilename.__class__.__name__
            )
            raise BaseException(strMessage)

    def delOutputFilename(self):
        self._outputFilename = None
    ...
    def setRot(self, rot):
        if rot is None:
            ...
            strMessage = (
                "ERROR! XSDataResultSupcomb.setRot argument is not XSDataRotation but %s"
    ...
    def setTrns(self, trns):
        if trns is None:
            ...
            strMessage = (
                "ERROR! XSDataResultSupcomb.setTrns argument is not XSDataVectorDouble but %s"
                % trns.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setNSD(self, NSD):
        if NSD is None:
            ...
            strMessage = (
                "ERROR! XSDataResultSupcomb.setNSD argument is not XSDataDouble but %s"
                % NSD.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def setModel(self, model):
        if model is None:
            ...
            strMessage = (
                "ERROR! XSDataResultSupcomb.setModel argument is not XSDataSaxsModel but %s"
                % model.__class__.__name__
            )
            raise BaseException(strMessage)
    ...
    def buildChildren(self, child_, nodeName_):
        if child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "outputFilename":
            obj_ = XSDataFile()
            obj_.build(child_)
            self.setOutputFilename(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "rot":
            obj_ = XSDataRotation()
            obj_.build(child_)
            self.setRot(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "trns":
            obj_ = XSDataVectorDouble()
            obj_.build(child_)
            self.setTrns(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "NSD":
            obj_ = XSDataDouble()
            obj_.build(child_)
            self.setNSD(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "model":
    ...
    def outputFile(self, _outfileName):
        print(
            "WARNING: Method outputFile in class XSDataResultSupcomb is deprecated, please use instead exportToFile!"
        )
        self.exportToFile(_outfileName)
